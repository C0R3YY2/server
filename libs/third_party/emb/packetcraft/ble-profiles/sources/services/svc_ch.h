...
#define CH_APPEAR_BCAST_DEVICE                2181    /*!< Broadcasting device */
#define CH_APPEAR_HA                          2624    /*!< Generic Hearing Aid */

#define CH_APPEAR_LEN                         2       /*!< Length in bytes*/
/**@}*/
...
#define CH_ALERT_LVL_LEN                      1       /*!< Length in bytes*/
/**@}*/
 ...
 */
/**@{*/
#define CH_HRM_LEN_VALUE_8BIT                 1       /*!< Heart rate measurement 8-bit value length. */
#define CH_HRM_LEN_VALUE_16BIT                2       /*!< Heart rate measurement 16-bit value length. */
#define CH_HRM_LEN_ENERGY_EXP                 2       /*!< Heart rate measurement exponent value length. */
#define CH_HRM_LEN_RR_INTERVAL                2       /*!< Heart rate measurement RR interval value length. */
/**@}*/
...
#define CH_BSENSOR_LOC_LEN                    1       /*!< Length in bytes */
/**@}*/
...
#define CH_HRCP_LEN                           1       /*!< Length of the control point value */
/**@}*/
...
/*! \brief System ID */
#define CH_SYSTEM_ID_LEN                      8       /*!< System ID value length. */

/*! \brief PnP ID */
#define CH_PNP_ID_LEN                         7       /*!< PnP ID value length. */

/*! \brief UDI for Medical Devices */
#define CH_UDI_MED_LEN                        1       /*!< UDI for Medical Devices min length. */

/*! \brief Battery Level */
#define CH_BATT_LEVEL_LEN                     1       /*!< Battery level value length. */
 ...
 */
/**@{*/
#define CH_BPM_FLAGS_LEN                      1       /*!< Blood pressure measurement flags length. */
#define CH_BPM_MEAS_LEN                       6       /*!< Blood pressure measurement measurement length. */
#define CH_BPM_TIMESTAMP_LEN                  7       /*!< Blood pressure measurement timestamp length. */
#define CH_BPM_PULSE_RATE_LEN                 2       /*!< Blood pressure measurement pulse rate length. */
#define CH_BPM_USER_ID_LEN                    1       /*!< Blood pressure measurement user ID length. */
#define CH_BPM_MEAS_STATUS_LEN                2       /*!< Blood pressure measurement status length. */
/**@}*/
...
#define CH_SFLOAT_POS_INF                     0x07FE  /*!< Positive infinity */
#define CH_SFLOAT_NEG_INF                     0x0802  /*!< Negative infinity */
 ...
 */
/**@{*/
#define CH_GLM_FLAGS_LEN                      1       /*!< Glucose measurement flags length. */
#define CH_GLM_SEQNUM_LEN                     2       /*!< Glucose measurement sequence number length. */
#define CH_GLM_TIMESTAMP_LEN                  7       /*!< Glucose measurement timestamp length. */
#define CH_GLM_TIME_OFFSET_LEN                2       /*!< Glucose measurement time offset length. */
#define CH_GLM_CONC_TYPE_LOC_LEN              3       /*!< Glucose measurement concentration type location length. */
#define CH_GLM_SENSOR_STATUS_LEN              2       /*!< Glucose measurement sensor status length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_GLMC_FLAGS_LEN                     1       /*!< Glucose measurement context flags length. */
#define CH_GLMC_SEQNUM_LEN                    2       /*!< Glucose measurement context sequence number length. */
#define CH_GLMC_CARB_LEN                      3       /*!< Glucose measurement context carbohydrate ID a d carbohydrate length. */
#define CH_GLMC_MEAL_LEN                      1       /*!< Glucose measurement context meal present length. */
#define CH_GLMC_TESTER_LEN                    1       /*!< Glucose measurement context tester-health length. */
#define CH_GLMC_EXERCISE_LEN                  3       /*!< Glucose measurement context exercise duration and exercise intensity length. */
#define CH_GLMC_MED_LEN                       3       /*!< Glucose measurement context medication ID length. */
#define CH_GLMC_HBA1C_LEN                     2       /*!< Glucose measurement context Hba1c length. */
#define CH_GLMC_EXT_LEN                       1       /*!< Glucose measurement context extended length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_TM_FLAGS_LEN                       1       /*!< Temperature measurement flags length. */
#define CH_TM_MEAS_LEN                        4       /*!< Temperature measurement measurement length. */
#define CH_TM_TIMESTAMP_LEN                   7       /*!< Temperature measurement timestamp length. */
#define CH_TM_TEMP_TYPE_LEN                   1       /*!< Temperature measurement type length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_WSM_FLAGS_LEN                      1       /*!< Weight scale measurement flags length. */
#define CH_WSM_MEAS_LEN                       2       /*!< Weight scale measurement measurement length. */
#define CH_WSM_TIMESTAMP_LEN                  7       /*!< Weight scale measurement timestamp length. */
#define CH_WSM_USER_ID_LEN                    1       /*!< Weight scale measurement user ID length. */
#define CH_WSM_BMI_HEIGHT_LEN                 4       /*!< Weight scale measurement BMI-height length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_SCPP_INTERVAL_WINDOW_LEN           4       /*!< Scan parameter profile interval window length. */
#define CH_SCPP_REFRESH_LEN                   0       /*!< Scan parameter profile refresh length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_CPS_MEASUREMENT_LEN                34      /*!< Cycling power profile measurement length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_CSCS_MEASUREMENT_LEN               11      /*!< Cycling speed profile measurement length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_RSCS_MEASUREMENT_LEN               10      /*!< Running speed profile measurement length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_PLXS_SPOT_CHECK_LEN                19      /*!< Pulse oximiter profile spot check length. */
#define CH_PLXS_CONTINUOUS_LEN                16      /*!< Pulse oximiter profile continuous length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_PLX_FLAGS_LEN                      1       /*!< Pulse oximiter flags length. */
#define CH_PLX_SPO2_LEN                       2       /*!< Pulse oximiter SPO2 length, */
#define CH_PLX_PULSE_LEN                      2       /*!< Pulse oximiter pulse length. */
#define CH_PLX_MEASUREMENT_STATUS_LEN         2       /*!< Pulse oximiter measurement status length. */
#define CH_PLX_SENSOR_STATUS_LEN              3       /*!< Pulse oximiter sensor status length. */
#define CH_PLX_PULSE_AMP_INDX_LEN             2       /*!< Pulse AMP index length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_PLXSC_TIMESTAMP_LEN                7       /*!< Pulse oximiter spot check measurement timestamp length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_PLXC_SPO2PR_FAST_LEN               2       /*!< Pulse oximiter continuous measurement SPO2PR fast length. */
#define CH_PLXC_SPO2PR_SLOW_LEN               2       /*!< Pulse oximiter continuous measurement SPO2PR slow length. */
/**@}*/
 ...
 */
/**@{*/
#define CH_PLXF_MIN_FEATURES_LEN              2       /*!< Pulse oximiter minimum features length. */
#define CH_PLXF_MAX_FEATURES_LEN              7       /*!< Pulse oximiter maximum features length. */
#define CH_PLXF_SENSOR_SUPPORT_LEN            2       /*!< Pulse oximiter sensor support length. */
#define CH_PLXF_MEASUREMENT_SUPPORT_LEN       2       /*!< Pulse oximeter measurement suppported length. */
/**@}*/
...
/** \name UDI for Medical Devices Flags
 *
 */
/**@{*/
#define CH_UDI_MED_FLAG_UDI_NONE              0x00    /*!< UDI NONE */
#define CH_UDI_MED_FLAG_UDI_LABEL             0x01    /*!< UDI Label is present */
#define CH_UDI_MED_FLAG_UDI_DID               0x02    /*!< UDI Device Identifier is present */
#define CH_UDI_MED_FLAG_UDI_ISS               0x04    /*!< UDI Issuer is present */
#define CH_UDI_MED_FLAG_UDI_AUTH              0x08    /*!< UDI Authority is present */
/**@}*/
