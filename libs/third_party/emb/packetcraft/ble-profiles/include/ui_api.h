...
#define UI_UNHANDLED_SEL_IND            12        /*!< Chosen selection item was not handled by the callback */
...
#define UI_INPUT_ENTER                  13        /*!< Enter key pressed - For console only. */
#define UI_INPUT_BELL                   14        /*!< Bell key pressed - For console and LCD. */
...
/*! \brief Menu auxiliary selections */
#define UI_MENU_ITEM_ON_OPEN            0         /*!< Event to selection handler when menu opens */
#define UI_MENU_ITEM_ON_ESC             10        /*!< Event to selection handler when ESC button is pressed */
#define UI_MENU_ITEM_ON_ENTER           11        /*!< Event to selection handler when ENTER button is pressed */
...
*/
/*************************************************************************************************/
bool UiPlatformGetBootStrapConfig(uint8_t pin);
