...
/* State machine */
bool lctrSlvExecuteEncryptSm(lctrConnCtx_t *pCtx, uint8_t event);
bool lctrExecutePingSm(lctrConnCtx_t *pCtx, uint8_t event);
bool lctrIsStartEncReqSent(lctrConnCtx_t *pCtx);
