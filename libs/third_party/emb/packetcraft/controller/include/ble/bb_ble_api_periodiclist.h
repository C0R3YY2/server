 ...
 */
/*************************************************************************************************/
bool BbBlePeriodicListCheckAddr(uint8_t addrType, uint64_t addr, uint8_t SID);
 ...
 */
/*************************************************************************************************/
bool BbBlePeriodicListAdd(uint8_t addrType, uint64_t addr, uint8_t SID);
 ...
 */
/*************************************************************************************************/
bool BbBlePeriodicListRemove(uint8_t addrType, uint64_t addr, uint8_t SID);
