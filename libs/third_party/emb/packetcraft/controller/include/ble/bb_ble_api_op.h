...
typedef void (*BbBlePawrComp_t)(uint8_t **pBuf, uint32_t base, uint32_t offset, uint32_t wwTotalUsec, BbBleRxQueueGet_t pRxQueueGetCb);
...
#if (LL_ENABLE_RSPOBS)
  uint8_t                 rspSlotMask;        /*!< Response observation TX slot mask. */
 ...
 */
/*************************************************************************************************/
void BbSlvPawrTxCompCback(uint8_t ** pBuf, uint32_t base, uint32_t offset, uint32_t wwTotalUsec, BbBleRxQueueGet_t pRxQueueGetCb);
