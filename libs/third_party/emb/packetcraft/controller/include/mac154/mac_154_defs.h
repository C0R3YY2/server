...
#define MAC_154_FC_SECURITY_ENABLED_SHIFT 3       /*!< TBD */
#define MAC_154_FC_SECURITY_ENABLED_MASK  0x0008  /*!< TBD */
#define MAC_154_FC_SECURITY_ENABLED(x)    (((x) & MAC_154_FC_SECURITY_ENABLED_MASK) >> MAC_154_FC_SECURITY_ENABLED_SHIFT) /*!< TBD */

#define MAC_154_FC_FRAME_PENDING_SHIFT    4       /*!< TBD */
#define MAC_154_FC_FRAME_PENDING_MASK     0x0010  /*!< TBD */
#define MAC_154_FC_FRAME_PENDING(x)       (((x) & MAC_154_FC_FRAME_PENDING_MASK) >> MAC_154_FC_FRAME_PENDING_SHIFT) /*!< TBD */

#define MAC_154_FC_ACK_REQUEST_SHIFT      5       /*!< TBD */
#define MAC_154_FC_ACK_REQUEST_MASK       0x0020  /*!< TBD */
#define MAC_154_FC_ACK_REQUEST(x)         (((x) & MAC_154_FC_ACK_REQUEST_MASK) >> MAC_154_FC_ACK_REQUEST_SHIFT) /*!< TBD */

#define MAC_154_FC_PAN_ID_COMP_SHIFT      6       /*!< TBD */
#define MAC_154_FC_PAN_ID_COMP_MASK       0x0040  /*!< TBD */
#define MAC_154_FC_PAN_ID_COMP(x)         (((x) & MAC_154_FC_PAN_ID_COMP_MASK) >> MAC_154_FC_PAN_ID_COMP_SHIFT) /*!< TBD */

#define MAC_154_FC_DST_ADDR_MODE_SHIFT    10      /*!< TBD */
#define MAC_154_FC_DST_ADDR_MODE_MASK     0x0C00  /*!< TBD */
#define MAC_154_FC_DST_ADDR_MODE(x)       (((x) & MAC_154_FC_DST_ADDR_MODE_MASK) >> MAC_154_FC_DST_ADDR_MODE_SHIFT) /*!< TBD */

#define MAC_154_FC_FRAME_VERSION_SHIFT    12      /*!< TBD */
#define MAC_154_FC_FRAME_VERSION_MASK     0x3000  /*!< TBD */
#define MAC_154_FC_FRAME_VERSION(x)       (((x) & MAC_154_FC_FRAME_VERSION_MASK) >> MAC_154_FC_FRAME_VERSION_SHIFT) /*!< TBD */

#define MAC_154_FC_SRC_ADDR_MODE_SHIFT    14      /*!< TBD */
#define MAC_154_FC_SRC_ADDR_MODE_MASK     0xC000  /*!< TBD */
#define MAC_154_FC_SRC_ADDR_MODE(x)       (((x) & MAC_154_FC_SRC_ADDR_MODE_MASK) >> MAC_154_FC_SRC_ADDR_MODE_SHIFT) /*!< TBD */
...
typedef uint8_t Mac154PibEnums_t;

#define MAC_154_PIB_ENUM_MIN            MAC_154_PIB_ENUM_ACK_WAIT_DURATION                 /*!< TBD */
#define MAC_154_PIB_ENUM_MAX            MAC_154_PIB_ENUM_SECURITY_ENABLED                  /*!< TBD */
#define MAC_154_PIB_ENUM_RANGE          (MAC_154_PIB_ENUM_MAX - MAC_154_PIB_ENUM_MIN + 1)  /*!< TBD */
...
typedef uint8_t Mac154PibVsEnums_t;

#define MAC_154_PIB_VS_ENUM_MIN         MAC_154_PIB_VS_ENUM_EXT_ADDR  /*!< TBD */
#define MAC_154_PIB_VS_ENUM_MAX         MAC_154_PIB_VS_ENUM_RAW_RX    /*!< TBD */
#define MAC_154_PIB_VS_ENUM_RANGE       (MAC_154_PIB_VS_ENUM_MAX - MAC_154_PIB_VS_ENUM_MIN + 1)  /*!< TBD */
...
typedef uint8_t Mac154PhyPibEnums_t;

#define MAC_154_PHY_PIB_ENUM_MIN         MAC_154_PHY_PIB_ENUM_CHANNEL     /*!< TBD */
#define MAC_154_PHY_PIB_ENUM_MAX         MAC_154_PHY_PIB_ENUM_TX_POWER    /*!< TBD */
#define MAC_154_PHY_PIB_ENUM_RANGE       (MAC_154_PHY_PIB_ENUM_MAX - MAC_154_PHY_PIB_ENUM_MIN + 1)  /*!< TBD */
...
typedef uint8_t Mac154FrameType_t;
...
typedef uint8_t Mac154CmdType_t;
...
#define MAC_154_CMD_FRAME_LEN_ASSOC_REQ_SHT       (MAC_154_CMD_FRAME_LEN_HDR(2,2,2,8) + 1) /*!< TBD */
#define MAC_154_CMD_FRAME_LEN_ASSOC_REQ_EXT       (MAC_154_CMD_FRAME_LEN_HDR(2,8,2,8) + 1) /*!< TBD */
#define MAC_154_CMD_FRAME_MAX_LEN_ASSOC_REQ       MAC_154_CMD_FRAME_LEN_ASSOC_REQ_EXT      /*!< TBD */

#define MAC_154_CMD_FRAME_LEN_ASSOC_RSP           (MAC_154_CMD_FRAME_LEN_HDR(2,8,0,8) + 2 + 1) /*!< TBD */

#define MAC_154_CMD_FRAME_LEN_DISASSOC_NTF_SHT    (MAC_154_CMD_FRAME_LEN_HDR(2,2,0,8) + 1) /*!< TBD */
#define MAC_154_CMD_FRAME_LEN_DISASSOC_NTF_EXT    (MAC_154_CMD_FRAME_LEN_HDR(2,8,0,8) + 1) /*!< TBD */
#define MAC_154_CMD_FRAME_MAX_LEN_DISASSOC_NTF    MAC_154_CMD_FRAME_LEN_ASSOC_RSP_EXT      /*!< TBD */

#define MAC_154_CMD_FRAME_LEN_DATA_REQ_SHT_SHT    (MAC_154_CMD_FRAME_LEN_HDR(2,2,0,2))     /*!< TBD */
#define MAC_154_CMD_FRAME_LEN_DATA_REQ_SHT_EXT    (MAC_154_CMD_FRAME_LEN_HDR(2,2,0,8))     /*!< TBD */
#define MAC_154_CMD_FRAME_LEN_DATA_REQ_EXT_SHT    (MAC_154_CMD_FRAME_LEN_HDR(2,8,0,2))     /*!< TBD */
#define MAC_154_CMD_FRAME_LEN_DATA_REQ_EXT_EXT    (MAC_154_CMD_FRAME_LEN_HDR(2,8,0,8))     /*!< TBD */
#define MAC_154_CMD_FRAME_MAX_LEN_DATA_REQ        MAC_154_CMD_FRAME_LEN_DATA_REQ_EXT_EXT   /*!< TBD */

#define MAC_154_CMD_FRAME_LEN_ORPHAN_NTF          (MAC_154_CMD_FRAME_LEN_HDR(2,2,0,8))     /*!< TBD */

#define MAC_154_CMD_FRAME_LEN_BEACON_REQ          (MAC_154_CMD_FRAME_LEN_HDR(2,2,0,0))     /*!< TBD */

#define MAC_154_CMD_FRAME_LEN_COORD_REALIGN_SHT   (MAC_154_CMD_FRAME_LEN_HDR(2,2,2,8) + 2 + 2 + 1 + 2) /*!< TBD */
#define MAC_154_CMD_FRAME_LEN_COORD_REALIGN_EXT   (MAC_154_CMD_FRAME_LEN_HDR(2,8,2,8) + 2 + 2 + 1 + 2) /*!< TBD */
...
typedef uint8_t Mac154AddrMode_t;

#define MAC_154_BROADCAST_PANID 0xffff      /*!< TBD */
#define MAC_154_BROADCAST_ADDR 0xffff       /*!< TBD */
#define MAC_154_UNASSIGNED_ADDR 0xffff      /*!< TBD */
#define MAC_154_NO_SHT_ADDR 0xfffe          /*!< TBD */
#define MAC_154_UNASSIGNED_PAN_ID 0xffff    /*!< TBD */

#define MAC_154_SHORT_ADDR_LEN      2       /*!< TBD */
#define MAC_154_EXTENDED_ADDR_LEN   8       /*!< TBD */
...
typedef uint8_t Mac154ScanType_t;
...
typedef uint8_t Mac154AssocStatus_t;
...
typedef uint8_t Mac154McpsTxOpt_t;
...
typedef uint8_t Mac154DevType_t;
...
#define MAC_154_RX_ACK_TIMEOUT_SYMB       MAC_154_aUnitBackoffPeriod + \
                                          ...
                                          (6 * PHY_154_phySymbolsPerOctet) /*!< TBD */
/*! PIB defaults */
...
/*! Disable CCA default */
#define MAC_154_PIB_DISABLE_CCA_DEF                     ((bool)false)

/*! Association permit default */
#define MAC_154_PIB_ASSOCIATION_PERMIT_DEF              ((bool)false)

/*! Associated PAN coordinator default */
#define MAC_154_PIB_ASSOCIATED_PAN_COORD_DEF            ((bool)false)

/*! Auto request default */
#define MAC_154_PIB_AUTO_REQUEST_DEF                    ((bool)true)
...
#define MAC_154_PIB_PROMISCUOUS_MODE_DEF                ((bool)false)

/*! Receive enabled default */
#define MAC_154_PIB_RX_ENABLED_DEF                      ((bool)false)

/*! Receive on when idle default */
#define MAC_154_PIB_RX_ON_WHEN_IDLE_DEF                 ((bool)false)
...
#define MAC_154_PIB_SECURITY_ENABLED_DEF                ((bool)false)
...
#define MAC_154_SECURITY_CONTROL_SHIFT_SECURITY_LEVEL       0   /*!< TBD */
#define MAC_154_SECURITY_CONTROL_SHIFT_KEY_IDENTIFIER_MODE  3   /*!< TBD */
...
typedef uint8_t Mac154SecLvl_t;
...
typedef uint8_t Mac154KeyIdMode_t;

/* Typedefs for unsigned int values larger than one byte represented as unsigned byte arrays */
typedef uint8_t uint16a_t[2];  /*!< TBD */
typedef uint8_t uint24a_t[3];  /*!< TBD */
typedef uint8_t uint64a_t[8];  /*!< TBD */
...
#define MAC_154_SIZEOF_ADDR_T     (1 + 2 + 8)      /*!< TBD */
...
/* Explicit size due to possible trailing packing */
#define MAC_154_SIZEOF_DATA_RX_IND_T     (2 * MAC_154_SIZEOF_ADDR_T + 1 + 1 + 1)   /*!< TBD */
