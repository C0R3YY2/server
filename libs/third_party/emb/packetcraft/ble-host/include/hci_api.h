...
// Include EM Bleu vendor specific HCI API
#include "emb_hci_vs_api.h"
...
#define HCI_LE_PER_ADV_START_CBACK_EVT                   52  /*!< \brief LE periodic advertising start event */
#define HCI_LE_SCAN_ENABLE_CMD_CMPL_CBACK_EVT            53  /*!< \brief LE scan enable command complete  */
#define HCI_LE_ADV_ENABLE_CMD_CMPL_CBACK_EVT             54  /*!< \brief LE advertise enable command complete  */
#define HCI_LE_EXT_SCAN_ENABLE_CMD_CMPL_CBACK_EVT        55  /*!< \brief LE extended scan enable command complete  */
#define HCI_LE_EXT_ADV_ENABLE_CMD_CMPL_CBACK_EVT         56  /*!< \brief LE extended advertise enable command complete  */
#define HCI_LE_PER_ADV_ENABLE_CMD_CMPL_CBACK_EVT         57  /*!< \brief LE periodic advertise enable command complete  */
#define HCI_LE_SET_RAND_ADDR_CMD_CMPL_CBACK_EVT          58  /*!< \brief LE set random address command complete  */
#define HCI_LE_PER_SYNC_TRSF_RCVD_CBACK_EVT              59  /*!< \brief LE periodic advertising sync transfer received event */
#define HCI_LE_PER_ADV_SYNC_TRSF_CMD_CMPL_CBACK_EVT      60  /*!< \brief LE periodic advertising sync transfer command complete  */
#define HCI_LE_PER_ADV_SET_INFO_TRSF_CMD_CMPL_CBACK_EVT  61  /*!< \brief LE set periodic advertising set info transfer command complete  */
#define HCI_LE_CONN_IQ_REPORT_CBACK_EVT                  62  /*!< \brief LE connection IQ report event */
#define HCI_LE_CTE_REQ_FAILED_CBACK_EVT                  63  /*!< \brief LE CTE request failed event */
#define HCI_LE_SET_CONN_CTE_RX_PARAMS_CMD_CMPL_CBACK_EVT 64  /*!< \brief LE set connection CTE receive parameters command complete */
#define HCI_LE_SET_CONN_CTE_TX_PARAMS_CMD_CMPL_CBACK_EVT 65  /*!< \brief LE set connection CTE transmit parameters command complete */
#define HCI_LE_CONN_CTE_REQ_ENABLE_CMD_CMPL_CBACK_EVT    66  /*!< \brief LE connection CTE request enable command complete */
#define HCI_LE_CONN_CTE_RSP_ENABLE_CMD_CMPL_CBACK_EVT    67  /*!< \brief LE connection CTE response enable  command complete */
#define HCI_LE_READ_ANTENNA_INFO_CMD_CMPL_CBACK_EVT      68  /*!< \brief LE read antenna information command complete */
#define HCI_LE_CIS_EST_CBACK_EVT                         69  /*!< \brief LE CIS established event */
#define HCI_LE_CIS_REQ_CBACK_EVT                         70  /*!< \brief LE CIS request event */
#define HCI_CIS_DISCONNECT_CMPL_CBACK_EVT                71  /*!< \brief CIS disconnect complete */
#define HCI_LE_REQ_PEER_SCA_CBACK_EVT                    72  /*!< \brief LE Request peer SCA complete */
#define HCI_LE_SET_CIG_PARAMS_CMD_CMPL_CBACK_EVT         73  /*!< \brief LE set CIG parameters command complete */
#define HCI_LE_REMOVE_CIG_CMD_CMPL_CBACK_EVT             74  /*!< \brief LE remove CIG command complete */
#define HCI_LE_SETUP_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT    75  /*!< \brief LE setup ISO data path command complete */
#define HCI_LE_REMOVE_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT   76  /*!< \brief LE remove ISO data path command complete */
#define HCI_CONFIG_DATA_PATH_CMD_CMPL_CBACK_EVT          77  /*!< \brief Configure data path command complete */
#define HCI_READ_LOCAL_SUP_CODECS_CMD_CMPL_CBACK_EVT     78  /*!< \brief Read local supported codecs command complete */
#define HCI_READ_LOCAL_SUP_CODEC_CAP_CMD_CMPL_CBACK_EVT  79  /*!< \brief Read local supported codec capabilities command complete */
#define HCI_READ_LOCAL_SUP_CTR_DLY_CMD_CMPL_CBACK_EVT    80  /*!< \brief Read local supported controller delay command complete */
#define HCI_LE_CREATE_BIG_CMPL_CBACK_EVT                 81  /*!< \brief LE create BIG complete */
#define HCI_LE_TERM_BIG_CMPL_CBACK_EVT                   82  /*!< \brief LE terminate BIG complete */
#define HCI_LE_BIG_SYNC_EST_CBACK_EVT                    83  /*!< \brief LE BIG sync established */
#define HCI_LE_BIG_SYNC_LOST_CBACK_EVT                   84  /*!< \brief LE BIG sync lost */
#define HCI_LE_BIG_TERM_SYNC_CMPL_CBACK_EVT              85  /*!< \brief LE BIG terminate sync complete */
#define HCI_LE_BIG_INFO_ADV_REPORT_CBACK_EVT             86  /*!< \brief LE BIG Info advertising report */
#define HCI_LE_SUBRATE_CHANGE_CBACK_EVT                  87  /*!< \brief LE subrate change */
#define HCI_LE_READ_ENH_TX_PWR_CMD_CMPL_CBACK_EVT        88  /*!< \brief LE enhanced read transmit power level command complete */
#define HCI_LE_SET_PATH_LOSS_RPT_PRM_CMD_CMPL_CBACK_EVT  89  /*!< \brief LE set path loss reporting parameters command complete */
#define HCI_LE_SET_PATH_LOSS_RPT_ENA_CMD_CMPL_CBACK_EVT  90  /*!< \brief LE set path loss reporting enable command complete */
#define HCI_LE_PATH_LOSS_REPORT_CBACK_EVT                91  /*!< \brief LE path loss threshold event */
#define HCI_LE_TX_POWER_REPORT_CBACK_EVT                 92  /*!< \brief LE transmit power reporting event */
#define HCI_LE_READ_ISO_LINK_QUAL_CMD_CMPL_CBACK_EVT     93  /*!< \brief LE read ISO link quality command complete */
#define HCI_LE_SET_DATA_REL_ADDR_CHG_CMD_CMPL_CBACK_EVT  94  /*!< \brief LE set data related address changes command complete */
#define HCI_LE_PER_ADV_RSP_REPORT_CBACK_EVT              95  /*!< \brief LE periodic advertising response report event */
#define HCI_LE_PER_ADV_SUBEVT_DATA_REQ_CBACK_EVT         96  /*!< \brief LE periodic advertising subevent data request event */
#define HCI_LE_SET_SUBEVT_DATA_CMD_CMPL_CBACK_EVT        97  /*!< \brief LE set periodic advertisement sub-event data command complete */
#define HCI_LE_SET_RESPONSE_DATA_CMD_CMPL_CBACK_EVT      98  /*!< \brief LE set periodic advertisement response data command complete */
#define HCI_LE_PER_ADV_OBV_REPORT_CBACK_EVT              99  /*!< \brief LE periodic advertising observation report event */
#define HCI_LE_MAX_CBACK_EVT                             HCI_LE_PER_ADV_OBV_REPORT_CBACK_EVT
...
/*! \brief     LE periodic advertising timing report (at periodic ad start) */
typedef struct
{
  wsfMsgHdr_t   hdr;            /*!< Event header. */
  uint16_t      syncHandle;     /*!< Sync or Advertising handle. */
...
} hciLePerAdvSyncTimingReportEvt_t;
...
typedef struct
{
  ...
  hciLePerAdvRspRptData_t dataHdr; /* TODO: Optimize reports by sending multiple responses in a single report. */
...
/*! \brief LE read ISO link quality command complete event */
typedef struct
{
  wsfMsgHdr_t         hdr;                  /*!< Event header. */
  uint8_t             status;               /*!< Status. */
  uint16_t            handle;               /*!< Connection handle of the CIS or BIS. */
  hciIsoLinkQual_t    stats;                /*!< ISO link quality statistics. */
} hciLeReadIsoLinkQualCmdCmplEvt_t;
...
typedef struct
{
  ...
  HciVsCodecInfo_t    vsCodecs[HCI_MAX_CODEC];      /*!< Vendor-specific codecs. */
  uint8_t             vsCodecTrans[HCI_MAX_CODEC];  /*!< Vendor-specific codec transport. */
...
typedef struct
{
  wsfMsgHdr_t         hdr;                          /*!< Event header. */
  uint8_t             status;                       /*!< Status. */
  uint8_t             numCodecCaps;                 /*!< \brief Number of codec capabilities. */
...
/*! \brief LE Enhanced Read Transmit Power Level command complete event */
typedef struct
{
  wsfMsgHdr_t         hdr;                  /*!< Event header. */
  uint8_t             status;               /*!< Status. */
  uint16_t            handle;               /*!< Connection handle. */
  uint8_t             phy;                  /*!< PHY read. */
  int8_t              curPwr;               /*!< Current Tx power level. */
  int8_t              maxPwr;               /*!< Maximum Tx power level. */
} hciLeEnhReadTxPwrLevelCmdCmplEvt_t;

/*! \brief LE Set Path Loss Reporting Parameters command complete event */
typedef struct
{
  wsfMsgHdr_t         hdr;                  /*!< Event header. */
  uint8_t             status;               /*!< Status. */
  uint16_t            handle;               /*!< Connection handle. */
} hciLeSetPathLossRptPrmCmdCmplEvt_t;

/*! \brief LE Set Path Loss Reporting Enable command complete event */
typedef struct
{
  wsfMsgHdr_t         hdr;                  /*!< Event header. */
  uint8_t             status;               /*!< Status. */
  uint16_t            handle;               /*!< Connection handle. */
} hciLeSetPathLossRptEnaCmdCmplEvt_t;

/*! \brief LE Transmit Power Reporting event. */
typedef struct
{
  wsfMsgHdr_t         hdr;                  /*!< Event header. */
  uint8_t             status;               /*!< Status. */
...
} HciLePathLossThresholdEvt_t;

/*! \brief LE Set Periodic Advertising sub-event data command complete event */
typedef struct
{
  wsfMsgHdr_t         hdr;                  /*!< Event header. */
  uint8_t             status;               /*!< Status. */
  uint8_t             advHandle;            /*!< Advertisement handle. */
} hciLeSetSubeventDataCmdCmplEvt_t;

/*! \brief LE Set Periodic Advertising response data command complete event */
typedef struct
{
  wsfMsgHdr_t         hdr;                  /*!< Event header. */
  uint8_t             status;               /*!< Status. */
  uint16_t            syncHandle;           /*!< Sync handle. */
} hciLeSetPerAdvRspDataCmdCmplEvt_t;
...
typedef union
{
  ...
  hciLePerAdvRspReportEvt_t           lePerAdvRspReport;           /*!< LE periodic advertising response report */
  hciLePerAdvSubDataReqEvt_t          lePerAdvSubDataReq;          /*!< LE periodic advertising subevent data request */
  ...
  hciLeEnhReadTxPwrLevelCmdCmplEvt_t  leEnhReadTxPwrLevelCmdCmpl;  /*!< LE enhanced read transmit power level command complete. */
  hciLeSetPathLossRptPrmCmdCmplEvt_t  leSetPathLossRptPrmCmdCmpl;  /*!< LE set path loss reporting parameters command complete. */
  hciLeSetPathLossRptEnaCmdCmplEvt_t  leSetPathLossRptEnaCmdCmpl;  /*!< LE set path loss reporting enable command complete. */
  HciLePowerReportEvt_t               lePowerRpt;                  /*!< LE transmit power reporting. */
  HciLePathLossThresholdEvt_t         lePathLoss;                  /*!< LE path loss threshold reporting. */
  hciLeReadIsoLinkQualCmdCmplEvt_t    leReadIsoLinkQual;           /*!< LE ISO link quality read. */
  hciLeSetSubeventDataCmdCmplEvt_t    leSetSubeventData;           /*!< LE set PAWR sub-event data. */
  hciLeSetPerAdvRspDataCmdCmplEvt_t   leSetPerAdvRspData;          /*!< LE set PAWR response data. */
} hciEvt_t;
...
typedef struct
{
  ...
  uint16_t            connLatency;     /*!< Maximum peripheral latency in number of events peripheral can skip. */
  uint16_t            supTimeout;      /*!< Supervision timeout in 10ms units. */
  uint16_t            minCeLen;        /*!< Minimum CE length in 0.625 units. */
  uint16_t            maxCeLen;        /*!< Maximum CE length in 0.625 units.. */
} hciConnSpec_t;
 ...
 *  \return None.
 */
typedef void (*hciFlowCback_t)(uint16_t handle, bool flowDisabled);
...
/*************************************************************************************************/
/*!
 *  \brief  Register a callback for vendor specific HCI events.
 *
 *  \param  evtCback  Callback function.
 *
 *  \return None.
 */
/*************************************************************************************************/
void HciVsEvtRegister(hciEvtCback_t evtCback);
...
*/
/*************************************************************************************************/
void HciSetLeSupFeat(uint64_t feat, bool flag);
 ...
 */
/*************************************************************************************************/
void HciSetLeSupFeat32(uint32_t feat, bool flag);
/**@}*/

/*************************************************************************************************/
/*!
*  \brief   Get LE supported features configuration mask.
*
*  \param   None
*
*  \return The LE supported features configuration mask.
*/
/*************************************************************************************************/
uint64_t HciGetLeConfigFeat(void);
/**@}*/
...
/*************************************************************************************************/
/*!
 *  \brief  HCI LE set data related address changes command.
 *
 ...
 */
/*************************************************************************************************/
void HciLeSetDataRelatedAddrChangesCmd(uint8_t advHandle, uint8_t changeReasons);
...
/*************************************************************************************************/
/*!
 *  \brief      HCI LE set extended advertising parameters command V2.
 *
 *  \param      advHandle    Advertising handle.
 *  \param      pExtAdvParam Extended advertising parameters.
 *
 ...
 */
/*************************************************************************************************/
void HciLeSetExtAdvParamCmdV2(uint8_t advHandle, hciExtAdvParam_t *pExtAdvParam);
...
/*************************************************************************************************/
/*!
 *  \brief      HCI LE set periodic advertising parameters command (version 2).
 *
 *  \param      advHandle       Advertising handle.
 *  \param      advIntervalMin  Periodic advertising interval minimum.
 *  \param      advIntervalMax  Periodic advertising interval maximum.
 ...
 *  \param      interval        Interval between subevents.
 *  \param      slotDelay       Time between adv packet in a subevent and 1st resp slot.
 *  \param      slotSpacing     Time between response slots.
 *  \param      numSlots        Number of subevent response slots.
 *
 *  \return None.
 */
/*************************************************************************************************/
void HciLeSetPerAdvParamCmdV2(uint8_t advHandle, uint16_t advIntervalMin, uint16_t advIntervalMax,
                              uint16_t advProps, uint8_t numSubevents, uint8_t interval,
...
/*************************************************************************************************/
/*!
 *  \brief      HCI LE set periodic advertising event notification enable.
 *
 *  \param      enable       Enable bits.
 *
 *  \return     None.
 */
/*************************************************************************************************/
void HciLeSetPeriodicAdvEventNotificationEnable(uint8_t enable);

/*************************************************************************************************/
/*!
 *  \brief      Set the subevent data for periodic advertising with response.
 *
 *  \param      advHandle   Advertising handle.
 ...
 */
/*************************************************************************************************/
void HciLeSetPerAdvSubeventData(uint8_t advHandle, uint8_t numParams, hciSubevtParam_t *pParam);

/*************************************************************************************************/
/*!
 *  \brief      Set the response data for periodic advertising with response.
 *
 ...
 */
/*************************************************************************************************/
void HciLeSetPerAdvResponseData(uint16_t syncHandle, uint16_t reqEvent, uint8_t reqSubevent, uint8_t subevent,
 ...
 *  \param      reqSubevent     Identifies subevent for the periodic advertising packet that the Host is responding to.
 *  \param      subevent        Subevent identifier.
 *  \param      rspCount        Number of responses.
 *  \param      rspList         List of responses.
 *
 *  \return     None.
 */
/*************************************************************************************************/
void HciLeExtSetPerAdvResponseData(uint16_t syncHandle, uint8_t role, uint16_t reqEvent, uint8_t reqSubevent, uint8_t subevent,
                                   uint8_t rspCount, HciExtPawrRspList_t *rspList);
 ...
 */
/*************************************************************************************************/
void hciLeSetPeriodicSyncSubevent(uint16_t syncHandle, uint16_t perAdvProp, uint8_t numSubevents,
                                     uint8_t *pSubevent);
 ...
 *
 *  \param      syncHandle      Periodic sync handle.
 *  \param      skip            Number of subevents to skip.
 *
 *  \return     None.
 */
/*************************************************************************************************/
void hciVsLeSetPeriodicScanImmediateSkip(uint16_t syncHandle, uint16_t skip);

/*************************************************************************************************/
/*!
 *  \brief      Called to enable the Packetcraft Vendor Specific PAWR Extension.
 *
 ...
 */
 /*************************************************************************************************/
void hciVsPawrExtensionEnable(bool enable);

/*************************************************************************************************/
/*!
 *  \brief      Called to select the responses to observe in a PAWR.
 *
 ...
 */
 /*************************************************************************************************/
void hciVsPawrSetObserverSlots(uint8_t handle, uint8_t subevt, uint8_t count, uint8_t *pRspList);
...
/*************************************************************************************************/
/*!
 *  \brief  HCI LE extended create connection command (version 2).
 *
 *  \param      advHandle       Advertising handle.
 *  \param      subevent        Subevent identifier.
 *  \param      pInitParam      Initiating parameters.
 ...
 */
/*************************************************************************************************/
void HciLeExtCreateConnCmdV2(uint8_t advHandle, uint8_t subevent, hciExtInitParam_t *pInitParam,
                             hciExtInitScanParam_t *pScanParam, hciConnSpec_t *pConnSpec);
...
/*************************************************************************************************/
/*!
 *  \brief      HCI LE read ISO link quality command.
 *
 *  \param      handle          Connection handle of the CIS (on Central or Peripheral) or BIS (on
 *                              Synchronized Receiver).
 *
 *  \return     None.
 */
/*************************************************************************************************/
void HciLeReadIsoLinkQualCmd(uint16_t handle);
 ...
 */
/*************************************************************************************************/
void HciLeSetHostFeatureCmd(uint8_t bitNum, bool bitVal);

/*************************************************************************************************/
/*!
 *  \brief      HCI LE Enhanced Read Transmit Power Level command.
 *
 *  \param      connHandle    Connection handle.
 *  \param      phy           PHY.
 *
 ...
 */
/*************************************************************************************************/
void HciLeEnhReadTxPowerLevel(uint16_t connHandle, uint8_t phy);

/*************************************************************************************************/
/*!
 *  \brief      HCI LE Read Remote Transmit Power Level command.
 *
 *  \param      connHandle    Connection handle.
 *  \param      phy           PHY.
 *
 ...
 */
/*************************************************************************************************/
void HciLeReadRemoteTxPowerLevel(uint16_t connHandle, uint8_t phy);

/*************************************************************************************************/
/*!
 *  \brief      HCI LE Set Path Loss Reporting Parameters command.
 *
 *  \param      connHandle    Connection handle.
 ...
 */
/*************************************************************************************************/
void HciLeSetPathLossReportingParams(uint16_t connHandle, uint8_t highThresh, uint8_t highHyst,
                                     uint8_t lowThresh, uint8_t lowHyst, uint16_t minTime);

/*************************************************************************************************/
/*!
 *  \brief      HCI LE Set Path Loss Reporting Enable command.
 *
 *  \param      connHandle    Connection handle.
 *  \param      enable        Enable.
 *
 ...
 */
/*************************************************************************************************/
void HciLeSetPathLossReportingEnable(uint16_t connHandle, uint8_t enable);

/*************************************************************************************************/
/*!
 *  \brief      HCI LE Set Transmit Power Reporting Enable command.
 *
 *  \param      connHandle    Connection handle.
 ...
 */
/*************************************************************************************************/
void HciLeSetTxPowerReportingEnable(uint16_t connHandle, uint8_t enableLocal, uint8_t enableRemote);
...
/*************************************************************************************************/
/*!
 *  \brief  HCI Set Eco system Base Interval command.
 *
 *  \return None.
 */
 /*************************************************************************************************/
void HciSetEcoSystemBaseIntervalCmd(uint16_t interval);
