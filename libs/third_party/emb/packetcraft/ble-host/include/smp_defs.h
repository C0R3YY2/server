 ...
 */
/**@{*/
#define SMP_OOB_DATA_NONE             0x00U      /*!< No OOB data from the remote device is present. */
#define SMP_OOB_DATA_PRESENT          0x01U      /*!< OOB data from the remote device is present. */
/**@}*/
 ...
 */
/**@{*/
#define SMP_AUTH_BOND_MASK            0x03U      /*!< Mask for bonding bits. */
#define SMP_AUTH_BOND_FLAG            0x01U      /*!< Bonding requested. */
#define SMP_AUTH_MITM_FLAG            0x04U      /*!< MITM (authenticated pairing) requested. */
#define SMP_AUTH_SC_FLAG              0x08U      /*!< LE Secure Connections requested. */
#define SMP_AUTH_KP_FLAG              0x10U      /*!< Keypress notifications requested. */
/**@}*/
 ...
 */
/**@{*/
#define SMP_KEY_DIST_ENC              0x01U      /*!< Distribute LTK. */
#define SMP_KEY_DIST_ID               0x02U      /*!< Distribute IRK. */
#define SMP_KEY_DIST_SIGN             0x04U      /*!< Distribute CSRK. */
 ...
 */
/**@{*/
#define SMP_PASSKEY_ENTRY_STARTED     0x00U      /*!< Passkey entry started keypress type. */
#define SMP_PASSKEY_DIGIT_ENTERED     0x01U      /*!< Passkey digit entered keypress type. */
#define SMP_PASSKEY_DIGIT_ERASED      0x02U      /*!< Passkey digit erased keypress type. */
#define SMP_PASSKEY_CLEARED           0x03U      /*!< Passkey cleared keypress type. */
#define SMP_PASSKEY_ENTRY_COMPLETED   0x04U      /*!< Passkey entry complete keypress type. */
/**@}*/
