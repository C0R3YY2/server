...
#define ATT_PREP_WRITE_CANCEL         0x7B      /*!< Cancel prepared write callback */
/**@}*/
 ...
 */
/**@{*/
#define ATT_PDU_MASK_SERVER           0x01U     /*!< Server bit mask */
#define ATT_PDU_MASK_COMMAND          0x40U     /*!< Command bit mask */
#define ATT_PDU_MASK_SIGNED           0x80U     /*!< Auth signature bit mask */
/**@}*/
 ...
 */
/**@{*/
#define ATT_HANDLE_NONE               0x0000U   /*!< Handle none. */
#define ATT_HANDLE_START              0x0001U   /*!< Handle start. */
#define ATT_HANDLE_MAX                0xFFFFU   /*!< Handle max. */
/**@}*/
...
*/
/**@{*/
#define ATTS_CSF_ROBUST_CACHING      (1U<<0)                 /*!< Robust caching. */
#define ATTS_CSF_EATT_BEARER         (1U<<1)                 /*!< Enhanced ATT Bearer. */
#define ATTS_CSF_MULTI_VAL_NTF       (1U<<2)                 /*!< Multiple Handle Value Notifications. */

#define ATTS_CSF_ALL_FEATURES        (0x7U)                  /*!< Mask of all client supported features. */
...
*/
/**@{*/
#define ATTS_SSF_EATT                (1U<<0)                  /*!< Enhanced ATT supported. */
/**@}*/
