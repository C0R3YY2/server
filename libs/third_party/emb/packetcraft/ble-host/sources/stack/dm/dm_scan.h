...
#define DM_SYNC_HCI_HANDLE_NONE     0xFFFFU
...
typedef struct
{
  ...
  bool                    encrypt;     /*!< Unencrypted or Encrypted */
...
/* sync with response component inteface */
void dmSyncWithRspInit(void);
void dmSyncWithRspReset(void);
void dmSyncWithRspHciHandler(hciEvt_t *pEvent);
