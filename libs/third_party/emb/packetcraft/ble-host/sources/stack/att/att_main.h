...
#define ATTC_MSG_START                0x00U
#define ATTS_MSG_START                0x20U
#define EATTC_MSG_START               0x40U
#define EATTS_MSG_START               0x60U
#define EATT_MSG_START                0x80U
...
#define ATT_CCB_STATUS_MTU_SENT       (1U<<0)        /* MTU req or rsp sent */
#define ATT_CCB_STATUS_FLOW_DISABLED  (1U<<1)        /* Data flow disabled */
#define ATT_CCB_STATUS_TX_TIMEOUT     (1U<<2)        /* ATT transaction timed out */
#define ATT_CCB_STATUS_RSP_PENDING    (1U<<3)        /* ATTS write rsp pending */
#define ATT_CCB_STATUS_CNF_PENDING    (1U<<4)        /* ATTC confirm pending */
#define ATT_CCB_STATUS_CONTEXT_LOCK   (1U<<5)        /* Slot held until API is processed in ATT */

/* Number of ATT bearers */
#define ATT_BEARER_MAX                (EATT_CONN_CHAN_MAX + 1)

/* Single ATT bearer slot ID */
#define ATT_BEARER_SLOT_ID            0U
#define ATT_BEARER_SLOT_INVALID       0xFFU
...
bool attUuidCmp16to128(const uint8_t *pUuid16, const uint8_t *pUuid128);
