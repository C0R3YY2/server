...
/* Maximum number of events for the WSF Dispatcher task. */
#define NUM_WSF_TASK_EVENTS                       (16u)
...
/*! \brief WSF task init callback function. */
typedef void (*WsfOsTaskInitCback_t)(void);
...
/*************************************************************************************************/
/*!
*  \brief  Initialize OS control structure ONLY, does NOT initialize main QPC event pools
*
*  \return None.
*/
/*************************************************************************************************/
void WsfOsInitOnly(void);

/*************************************************************************************************/
/*!
*  \brief  Starts OS control structure ONLY, does NOT initialize main QPC event pools
*
*  \return None.
*/
/*************************************************************************************************/
void WsfOsStartOnly(void);
...
/*************************************************************************************************/
/*!
 *  \brief  WSF OS register a callback when the WSF task is started.
 *
 *  \param  taskInitCback Callback that will be called when WSK task is started.
 */
/*************************************************************************************************/
void WsfOsRegisterTaskInitCback(WsfOsTaskInitCback_t taskInitCback);
