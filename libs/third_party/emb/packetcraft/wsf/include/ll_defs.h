...
#define LL_VER_BT_CORE_SPEC_ATLANTA 0x0E    /*!< Bluetooth core specification Atlanta */
...
#define LL_CTE_TYPE_BIT_POS               6U      /*!< CTE Info CTE type bit position. */
#define LL_CTE_MAX_SAMPLE_COUNT           0x10U   /*!< Maximum sample count of a periodic advertising event. */
#define LL_CTE_TIME_MAX                   0x14U   /*!< Maximum possible CTE time. */
#define LL_CTE_TIME_MIN                   0x02U   /*!< Smallest possible CTE time. */
#define LL_CTE_IQ_SAMPLE_DATA_LEN_MAX     164U    /*!< Maximum possible byte length of CTE IQ data, two bytes per sample (I and Q) assuming 1us slot durations (refrence period is also sampled). */
#define LL_CTE_SLOT_DURATION_NONE         0x00U   /*!< No switching and sampling */
#define LL_CTE_SLOT_DURATION_1_US         0x01U   /*!< Switching and sampling slots are 1 us each */
#define LL_CTE_SLOT_DURATION_2_US         0x02U   /*!< Switching and sampling slots are 2 us each */
...
enum
{
  ...
  /* --- Core Spec Atlanta --- ATLANTA TODO: Replace with actual opcodes */
  ...
  LL_PDU_CS_TERMINATE_IND       = 0x35, /*< CS terminate indication PDU. */
...
#define LL_CS_TERMINATE_IND_LEN       4       /*< CS terminate indication PDU length. */
...
/* Note: value tuned for EM HW. */
#define LL_MIN_CIS_OFFSET_USEC        1456    /*!< Minimum first CIS anchor point offset of ACL anchorpoint. */
...
#define LL_CS_MAX_CHANNEL_LENGTH          0x04   /*!< Maximum CS channel length. */
...
#define LL_CS_MAX_SUBEVENTS_PER_PROCEDURE 32    /*!< Maximum number of CS subevents within any CS procedure. */
