 ...
 */
/**@{*/
#define HCI_CMD_HDR_LEN                              3U       /*!< Command packet header length */
#define HCI_ACL_HDR_LEN                              4U       /*!< ACL packet header length */
#define HCI_ISO_HDR_LEN                              4U       /*!< ISO packet header length */
#define HCI_EVT_HDR_LEN                              2U       /*!< Event packet header length */
#define HCI_EVT_PARAM_MAX_LEN                        255U     /*!< Maximum length of event packet parameters */
#define HCI_ACL_DEFAULT_LEN                          27U      /*!< Default maximum ACL packet length */
#define HCI_PB_FLAG_MASK                             0x3000U  /*!< ACL packet boundary flag mask */
#define HCI_PB_START_H2C                             0x0000U  /*!< Packet boundary flag, start, host-to-controller */
#define HCI_PB_CONTINUE                              0x1000U  /*!< Packet boundary flag, continue */
#define HCI_PB_START_C2H                             0x2000U  /*!< Packet boundary flag, start, controller-to-host */
#define HCI_HANDLE_MASK                              0x0FFFU  /*!< Mask for handle bits in ACL packet */
#define HCI_HANDLE_NONE                              0xFFFFU  /*!< Value for invalid handle */
#define HCI_ISO_GROUP_ID_NONE                        0xFFU    /*!< Value for invalid CIG/BIG ID */


/* ISO Header. */
#define HCI_TS_FLAG_MASK                             (1U << 14)
                                                             /*!< Timestamp flag mask for ISO packets. */
#define HCI_DATA_LOAD_LEN_MASK                       0x3FFF  /*!< HCI Data load length. */

/* ISO Data load. */
#define HCI_ISO_DL_MIN_LEN                           4U      /*!< ISO Data Load header minimum length */
#define HCI_ISO_DL_MAX_LEN                           8U      /*!< ISO Data Load header maximum length */
#define HCI_ISO_TS_LEN                               4U      /*!< ISO Data Load timestamp length */
#define HCI_ISO_DL_SDU_LEN_MASK                      0x0FFFU /*!< HCI SDU Length mask. */
#define HCI_ISO_DL_PS_MASK                           0xC000U /*!< HCI Packet status mask. */
...
/* Version 5.2 */
#define HCI_ERR_PKT_TOO_LATE                         0x46    /*!< Packet too late */
#define HCI_ERR_PKT_TOO_EARLY                        0x47    /*!< Packet too early */
/**@}*/
...
#define HCI_OCF_READ_CONN_ACCEPT_TIMEOUT             0x15
#define HCI_OCF_WRITE_CONN_ACCEPT_TIMEOUT            0x16
...
/* Version 5.2 */
#define HCI_OCF_SET_ECOSYSTEM_BASE_INTERVAL          0x82
...
#define HCI_OCF_LE_SET_PER_SUB_DATA                  0x82
#define HCI_OCF_LE_SET_PER_RESP_DATA                 0x83
#define HCI_OCF_LE_SET_PER_SYNC_SUBEVENT             0x84
#define HCI_OCF_LE_EXT_CREATE_CONN_V2                0x85
#define HCI_OCF_LE_SET_PER_ADV_PARAM_V2              0x86
/* Version Atlanta */
#define HCI_OCF_LE_SET_DECISION_DATA                 0x80
#define HCI_OCF_LE_SET_DECISION_INSTRUCTIONS         0x81
#define HCI_OCF_LE_CS_READ_LOCAL_SUP_CAP             0x89
#define HCI_OCF_LE_CS_READ_REMOTE_SUP_CAP            0x8A
#define HCI_OCF_LE_CS_WRITE_CACH_REMOTE_SUP_CAP      0x8B
#define HCI_OCF_LE_CS_SECURITY_ENABLE                0x8C
#define HCI_OCF_LE_CS_SET_DEFAULT_SETTINGS           0x8D
#define HCI_OCF_LE_CS_READ_REMOTE_FAE_TBL            0x8E
#define HCI_OCF_LE_CS_WRITE_CACH_REMOTE_FAE_TBL      0x8F
#define HCI_OCF_LE_CS_CREATE_CONFIG                  0x90
#define HCI_OCF_LE_CS_REMOVE_CONFIG                  0x91
#define HCI_OCF_LE_CS_SET_CHAN_CLASSIFICATION        0x92
#define HCI_OCF_LE_CS_SET_PROC_PARAMS                0x93
#define HCI_OCF_LE_CS_PROCEDURE_ENABLE               0x94
#define HCI_OCF_LE_CS_TEST                           0x95
#define HCI_OCF_LE_CS_TEST_END                       0x96
/**@}*/
...
#endif // HCI_OPCODE_RESET

#define HCI_OPCODE_READ_CONN_ACCEPT_TIMEOUT          HCI_OPCODE(HCI_OGF_CONTROLLER, HCI_OCF_READ_CONN_ACCEPT_TIMEOUT)
#define HCI_OPCODE_WRITE_CONN_ACCEPT_TIMEOUT         HCI_OPCODE(HCI_OGF_CONTROLLER, HCI_OCF_WRITE_CONN_ACCEPT_TIMEOUT)
...
#define HCI_OPCODE_SET_ECOSYSTEM_BASE_INTERVAL       HCI_OPCODE(HCI_OGF_CONTROLLER, HCI_OCF_SET_ECOSYSTEM_BASE_INTERVAL)
...
#define HCI_OPCODE_LE_SET_PER_SUB_DATA               HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_SET_PER_SUB_DATA)
#define HCI_OPCODE_LE_SET_PER_RESP_DATA              HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_SET_PER_RESP_DATA)
#define HCI_OPCODE_LE_SET_PER_SYNC_SUBEVENT          HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_SET_PER_SYNC_SUBEVENT)
...
/* Version Atlanta */
#define HCI_OPCODE_LE_CS_READ_LOCAL_SUP_CAP          HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_READ_LOCAL_SUP_CAP)
#define HCI_OPCODE_LE_CS_READ_REMOTE_SUP_CAP         HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_READ_REMOTE_SUP_CAP)
#define HCI_OPCODE_LE_CS_WRITE_CACH_REMOTE_SUP_CAP   HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_WRITE_CACH_REMOTE_SUP_CAP)
#define HCI_OPCODE_LE_CS_SECURITY_ENABLE             HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_SECURITY_ENABLE)
#define HCI_OPCODE_LE_CS_SET_DEFAULT_SETTINGS        HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_SET_DEFAULT_SETTINGS)
#define HCI_OPCODE_LE_CS_READ_REMOTE_FAE_TBL         HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_READ_REMOTE_FAE_TBL)
#define HCI_OPCODE_LE_CS_WRITE_CACH_REMOTE_FAE_TBL   HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_WRITE_CACH_REMOTE_FAE_TBL)
#define HCI_OPCODE_LE_CS_CREATE_CONFIG               HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_CREATE_CONFIG)
#define HCI_OPCODE_LE_CS_REMOVE_CONFIG               HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_REMOVE_CONFIG)
#define HCI_OPCODE_LE_CS_SET_CHAN_CLASSIFICATION     HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_SET_CHAN_CLASSIFICATION)
#define HCI_OPCODE_LE_CS_SET_PROC_PARAMS             HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_SET_PROC_PARAMS)
#define HCI_OPCODE_LE_CS_PROCEDURE_ENABLE            HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_PROCEDURE_ENABLE)
#define HCI_OPCODE_LE_CS_TEST                        HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_TEST)
#define HCI_OPCODE_LE_CS_TEST_END                    HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CS_TEST_END)
#define HCI_OPCODE_LE_SET_DECISION_DATA              HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_SET_DECISION_DATA)
#define HCI_OPCODE_LE_SET_DECISION_INSTRUCTIONS      HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_SET_DECISION_INSTRUCTIONS)
/**@}*/
...
#define HCI_LEN_LE_READ_ISO_LINK_QUAL                2
#define HCI_LEN_LE_READ_ENHANCED_TX_POWER            3
#define HCI_LEN_LE_READ_REMOTE_TX_POWER              3
#define HCI_LEN_LE_SET_PATH_LOSS_RPT_PARAMS          8
#define HCI_LEN_LE_SET_PATH_LOSS_RPT_ENABLE          3
#define HCI_LEN_LE_SET_TX_POWER_REPORT_ENABLE        4

/* Version 5.2 */
#define HCI_LEN_SET_ECO_SYSTEM_INTERVAL              2

/* Version 5.3 */
#define HCI_LEN_LE_SET_DATA_REL_ADDR_CHANGES         2
#define HCI_LEN_LE_SET_DEF_SUBRATE                   10
#define HCI_LEN_LE_SUBRATE_REQ                       12
/* Version 5.4 */
#define HCI_LEN_LE_SET_PER_SUB_DATA_HDR              2
#define HCI_LEN_LE_SET_PER_SUB_DATA_PARAMS           4
#define HCI_LEN_LE_SET_PER_ADV_RSP_DATA              8
#define HCI_LEN_LE_SET_PER_ADV_SYNC_SUB              5
...
/* Version Atlanta */
#define HCI_LEN_LE_CS_READ_LOCAL_SUP_CAP             0
#define HCI_LEN_LE_CS_READ_REMOTE_SUP_CAP            2
#define HCI_LEN_LE_CS_WRITE_CACH_REMOTE_SUP_CAP      29
#define HCI_LEN_LE_CS_SECURITY_ENABLE                2
#define HCI_LEN_LE_CS_SET_DEFAULT_SETTINGS           5
#define HCI_LEN_LE_CS_READ_REMOTE_FAE_TABLE          2
#define HCI_LEN_LE_CS_WRITE_CACH_REMOTE_FAE_TABLE    74
#define HCI_LEN_LE_CS_CREATE_CONFIG                  28
#define HCI_LEN_LE_CS_REMOVE_CONFIG                  3
#define HCI_LEN_LE_CS_SET_CHAN_CLASSIFICATION        10
#define HCI_LEN_LE_CS_SET_PROC_PARAMS                21
#define HCI_LEN_LE_CS_PROCEDURE_ENABLE               4
#define HCI_LEN_LE_CS_TEST                           57 /* + Override_Parameters_Length + Channel_Length*/
#define HCI_LEN_LE_CS_TEST_END                       0
/* Vendor Specific */
#define HCI_LEN_VS_PAWR_EXT_ENABLE                   1
#define HCI_LEN_VS_PAWR_OBSERVER_RSP_LIST            3
#define HCI_LEN_VS_PAWR_SET_RSP_OBS_DATA             5
#define HCI_LEN_VS_SET_PER_SCAN_IMMED_SKIP           4
...
/* Version 5.4 */
#define HCI_LE_PER_ADV_SYNC_EST_V2_EVT               0x24
#define HCI_LE_PER_ADV_REPORT_V2_EVT                 0x25
#define HCI_LE_PER_SYNC_TRSF_RCVD_V2_EVT             0x26
#define HCI_LE_PER_ADV_SUBEVENT_DATA_REQ_EVT         0x27
#define HCI_LE_PER_ADV_RSP_REPORT_EVT                0x28
#define HCI_LE_ENHANCED_CONN_CMPL_V2_EVT             0x29
/* Version Atlanta */
#define HCI_LE_CS_READ_REMOTE_SUP_CAP_CMPL_EVT       0x2C
#define HCI_LE_CS_READ_REMOTE_FAE_TBL_CMPL_EVT       0x2D
#define HCI_LE_CS_SECURITY_ENABLE_CMPL_EVT           0x2E
#define HCI_LE_CS_CONFIG_CMPL_EVT                    0x2F
#define HCI_LE_CS_PROCEDURE_ENABLE_CMPL_EVT          0x30
#define HCI_LE_CS_SUBEVENT_RESULT_EVT                0x31
#define HCI_LE_CS_SUBEVENT_RESULT_CON_EVT            0x32
...
/* Version 5.4 */
#define HCI_LEN_LE_PER_ADV_RSP_REPORT                11      /*!< Periodic advertising response report event length. */
#define HCI_LEN_LE_PER_ADV_SYNC_EST_V2               20      /*!< Periodic advertising sync established event length (version 2). */
#define HCI_LEN_LE_PER_ADV_REPORT_V2                 11      /*!< Periodic advertising report event length (version 2). */
#define HCI_LEN_LE_PER_SYNC_TRSF_RCVD_V2             24      /*!< Periodic advertising sync transfer received event length (version 2). */
#define HCI_LEN_LE_PER_ADV_SUB_DATA_REQ              4       /*!< Periodic advertising subevent data request. */
#define HCI_LEN_LE_ENHANCED_CONN_CMPL_V2             34      /*!< Enhanced connection complete event length (version 2). */
/* Version Atlanta */
#define HCI_LEN_LE_CS_READ_REMOTE_SUP_CAP_CMPL_EVT   32      /*!< Read remote supported capabilities complete event length. */
#define HCI_LEN_LE_CS_READ_REMOTE_FAE_TBL_CMPL_EVT   76      /*!< Read remote FAE table complete event length. */
#define HCI_LEN_LE_CS_SECURITY_ENABLE_CMPL_EVT       4       /*!< Security enable complete event length. */
#define HCI_LEN_LE_CS_CONFIG_CMPL_EVT                34      /*!< Configuration complete event length. */
#define HCI_LEN_LE_CS_PROCEDURE_ENABLE_CMPL_EVT      20      /*!< Procedure enable complete event length. */
#define HCI_LEN_LE_CS_SUBEVENT_RESULT_EVT            0       /*!< Subevent result event length. */
#define HCI_LEN_LE_CS_SUBEVENT_RESULT_CON_EVT        0       /*!< Subevent result continue event length. */
#define HCI_LEN_LE_CS_TEST_END_CMPL_EVT              2       /*!< Test end complete event. */
/**@}*/
 ...
 */
/**@{*/
#define HCI_SUP_DISCONNECT                           0x20U    /*!< Byte 0 */
#define HCI_SUP_READ_REMOTE_VER_INFO                 0x80U    /*!< Byte 2 */
#define HCI_SUP_SET_EVENT_MASK                       0x40U    /*!< Byte 5 */
#define HCI_SUP_RESET                                0x80U    /*!< Byte 5 */
#define HCI_SUP_READ_CONN_ACCEPT_TIMEOUT             0x04U    /*!< Byte 7 */
#define HCI_SUP_WRITE_CONN_ACCEPT_TIMEOUT            0x08U    /*!< Byte 7 */
#define HCI_SUP_READ_TX_PWR_LVL                      0x04U    /*!< Byte 10 */
#define HCI_SUP_SET_CONTROLLER_TO_HOST_FLOW_CONTROL  0x20U    /*!< Byte 10 */
#define HCI_SUP_HOST_BUFFER_SIZE                     0x40U    /*!< Byte 10 */
#define HCI_SUP_HOST_NUM_OF_COMPLETED_PACKETS        0x80U    /*!< Byte 10 */
#define HCI_SUP_READ_AFH_CHAN_ASSESSMENT_MODE        0x04U    /*!< Byte 13 */
#define HCI_SUP_WRITE_AFH_CHAN_ASSESSMENT_MODE       0x08U    /*!< Byte 13 */
#define HCI_SUP_READ_LOCAL_VER_INFO                  0x08U    /*!< Byte 14 */
#define HCI_SUP_READ_LOCAL_SUP_FEAT                  0x20U    /*!< Byte 14 */
#define HCI_SUP_READ_BD_ADDR                         0x02U    /*!< Byte 15 */
#define HCI_SUP_READ_RSSI                            0x20U    /*!< Byte 15 */
#define HCI_SUP_SET_EVENT_MASK_PAGE2                 0x04U    /*!< Byte 22 */
#define HCI_SUP_LE_SET_EVENT_MASK                    0x01U    /*!< Byte 25 */
#define HCI_SUP_LE_READ_BUF_SIZE                     0x02U    /*!< Byte 25 */
#define HCI_SUP_LE_READ_LOCAL_SUP_FEAT               0x04U    /*!< Byte 25 */
#define HCI_SUP_LE_SET_RAND_ADDR                     0x10U    /*!< Byte 25 */
#define HCI_SUP_LE_SET_ADV_PARAM                     0x20U    /*!< Byte 25 */
#define HCI_SUP_LE_READ_ADV_TX_POWER                 0x40U    /*!< Byte 25 */
#define HCI_SUP_LE_SET_ADV_DATA                      0x80U    /*!< Byte 25 */
#define HCI_SUP_LE_SET_SCAN_RESP_DATA                0x01U    /*!< Byte 26 */
#define HCI_SUP_LE_SET_ADV_ENABLE                    0x02U    /*!< Byte 26 */
#define HCI_SUP_LE_SET_SCAN_PARAM                    0x04U    /*!< Byte 26 */
#define HCI_SUP_LE_SET_SCAN_ENABLE                   0x08U    /*!< Byte 26 */
#define HCI_SUP_LE_CREATE_CONN                       0x10U    /*!< Byte 26 */
#define HCI_SUP_LE_CREATE_CONN_CANCEL                0x20U    /*!< Byte 26 */
#define HCI_SUP_LE_READ_WHITE_LIST_SIZE              0x40U    /*!< Byte 26 */
#define HCI_SUP_LE_CLEAR_WHITE_LIST                  0x80U    /*!< Byte 26 */
#define HCI_SUP_LE_ADD_DEV_WHITE_LIST                0x01U    /*!< Byte 27 */
#define HCI_SUP_LE_REMOVE_DEV_WHITE_LIST             0x02U    /*!< Byte 27 */
#define HCI_SUP_LE_CONN_UPDATE                       0x04U    /*!< Byte 27 */
#define HCI_SUP_LE_SET_HOST_CHAN_CLASS               0x08U    /*!< Byte 27 */
#define HCI_SUP_LE_READ_CHAN_MAP                     0x10U    /*!< Byte 27 */
#define HCI_SUP_LE_READ_REMOTE_FEAT                  0x20U    /*!< Byte 27 */
#define HCI_SUP_LE_ENCRYPT                           0x40U    /*!< Byte 27 */
#define HCI_SUP_LE_RAND                              0x80U    /*!< Byte 27 */
#define HCI_SUP_LE_START_ENCRYPTION                  0x01U    /*!< Byte 28 */
#define HCI_SUP_LE_LTK_REQ_REPL                      0x02U    /*!< Byte 28 */
#define HCI_SUP_LE_LTK_REQ_NEG_REPL                  0x04U    /*!< Byte 28 */
#define HCI_SUP_LE_READ_SUP_STATES                   0x08U    /*!< Byte 28 */
#define HCI_SUP_LE_RECEIVER_TEST                     0x10U    /*!< Byte 28 */
#define HCI_SUP_LE_TRANSMITTER_TEST                  0x20U    /*!< Byte 28 */
#define HCI_SUP_LE_TEST_END                          0x40U    /*!< Byte 28 */
#define HCI_SUP_READ_AUTH_PAYLOAD_TO                 0x10U    /*!< Byte 32 */
#define HCI_SUP_WRITE_AUTH_PAYLOAD_TO                0x20U    /*!< Byte 32 */
/* Version 4.1 */
#define HCI_SUP_LE_REM_CONN_PARAM_REQ_REPL           0x10U    /*!< Byte 33 */
#define HCI_SUP_LE_REM_CONN_PARAM_REQ_NEG_REPL       0x20U    /*!< Byte 33 */
/* Version 4.2 */
#define HCI_SUP_LE_SET_DATA_LEN                      0x40U    /*!< Byte 33 */
#define HCI_SUP_LE_READ_DEF_DATA_LEN                 0x80U    /*!< Byte 33 */
#define HCI_SUP_LE_WRITE_DEF_DATA_LEN                0x01U    /*!< Byte 34 */
#define HCI_SUP_LE_READ_LOCAL_P256_PUB_KEY           0x02U    /*!< Byte 34 */
#define HCI_SUP_LE_GENERATE_DHKEY                    0x04U    /*!< Byte 34 */
#define HCI_SUP_LE_ADD_DEV_RES_LIST_EVT              0x08U    /*!< Byte 34 */
#define HCI_SUP_LE_REMOVE_DEV_RES_LIST               0x10U    /*!< Byte 34 */
#define HCI_SUP_LE_CLEAR_RES_LIST                    0x20U    /*!< Byte 34 */
#define HCI_SUP_LE_READ_RES_LIST_SIZE                0x40U    /*!< Byte 34 */
#define HCI_SUP_LE_READ_PEER_RES_ADDR                0x80U    /*!< Byte 34 */
#define HCI_SUP_LE_READ_LOCAL_RES_ADDR               0x01U    /*!< Byte 35 */
#define HCI_SUP_LE_SET_ADDR_RES_ENABLE               0x02U    /*!< Byte 35 */
#define HCI_SUP_LE_SET_RES_PRIV_ADDR_TO              0x04U    /*!< Byte 35 */
#define HCI_SUP_LE_READ_MAX_DATA_LEN                 0x08U    /*!< Byte 35 */
/* Version 5.0 */
#define HCI_SUP_LE_READ_PHY                          0x10U    /*!< Byte 35 */
#define HCI_SUP_LE_SET_DEF_PHY                       0x20U    /*!< Byte 35 */
#define HCI_SUP_LE_SET_PHY                           0x40U    /*!< Byte 35 */
#define HCI_SUP_LE_ENHANCED_RECEIVER_TEST            0x80U    /*!< Byte 35 */
#define HCI_SUP_LE_ENHANCED_TRANSMITTER_TEST         0x01U    /*!< Byte 36 */
#define HCI_SUP_LE_SET_ADV_SET_RAND_ADDR             0x02U    /*!< Byte 36 */
#define HCI_SUP_LE_SET_EXT_ADV_PARAM                 0x04U    /*!< Byte 36 */
#define HCI_SUP_LE_SET_EXT_ADV_DATA                  0x08U    /*!< Byte 36 */
#define HCI_SUP_LE_SET_EXT_SCAN_RESP_DATA            0x10U    /*!< Byte 36 */
#define HCI_SUP_LE_SET_EXT_ADV_ENABLE                0x20U    /*!< Byte 36 */
#define HCI_SUP_LE_READ_MAX_ADV_DATA_LEN             0x40U    /*!< Byte 36 */
#define HCI_SUP_LE_READ_NUM_OF_SUP_ADV_SETS          0x80U    /*!< Byte 36 */
#define HCI_SUP_LE_REMOVE_ADV_SET                    0x01U    /*!< Byte 37 */
#define HCI_SUP_LE_CLEAR_ADV_SETS                    0x02U    /*!< Byte 37 */
#define HCI_SUP_LE_SET_PER_ADV_PARAM                 0x04U    /*!< Byte 37 */
#define HCI_SUP_LE_SET_PER_ADV_DATA                  0x08U    /*!< Byte 37 */
#define HCI_SUP_LE_SET_PER_ADV_ENABLE                0x10U    /*!< Byte 37 */
#define HCI_SUP_LE_SET_EXT_SCAN_PARAM                0x20U    /*!< Byte 37 */
#define HCI_SUP_LE_SET_EXT_SCAN_ENABLE               0x40U    /*!< Byte 37 */
#define HCI_SUP_LE_EXT_CREATE_CONN                   0x80U    /*!< Byte 37 */
#define HCI_SUP_LE_PER_ADV_CREATE_SYNC               0x01U    /*!< Byte 38 */
#define HCI_SUP_LE_PER_ADV_CREATE_SYNC_CANCEL        0x02U    /*!< Byte 38 */
#define HCI_SUP_LE_PER_ADV_TERMINATE_SYNC            0x04U    /*!< Byte 38 */
#define HCI_SUP_LE_ADD_DEV_PER_ADV_LIST              0x08U    /*!< Byte 38 */
#define HCI_SUP_LE_REMOVE_DEV_PER_ADV_LIST           0x10U    /*!< Byte 38 */
#define HCI_SUP_LE_CLEAR_PER_ADV_LIST                0x20U    /*!< Byte 38 */
#define HCI_SUP_LE_READ_PER_ADV_LIST_SIZE            0x40U    /*!< Byte 38 */
#define HCI_SUP_LE_READ_TX_POWER                     0x80U    /*!< Byte 38 */
#define HCI_SUP_LE_READ_RF_PATH_COMP                 0x01U    /*!< Byte 39 */
#define HCI_SUP_LE_WRITE_RF_PATH_COMP                0x02U    /*!< Byte 39 */
#define HCI_SUP_LE_SET_PRIVACY_MODE                  0x04U    /*!< Byte 39 */
/* Version 5.1 */
#define HCI_SUP_LE_RECEIVER_TEST_V3                  0x08U    /*!< Byte 39 */
#define HCI_SUP_LE_TRANSMITTER_TEST_V3               0x10U    /*!< Byte 39 */
#define HCI_SUP_LE_SET_CONNLESS_CTE_TX_PARAMS        0x20U    /*!< Byte 39 */
#define HCI_SUP_LE_SET_CONNLESS_CTE_TX_ENABLE        0x40U    /*!< Byte 39 */
#define HCI_SUP_LE_SET_CONNLESS_IQ_SAMP_ENABLE       0x80U    /*!< Byte 39 */
#define HCI_SUP_LE_SET_CONN_CTE_RX_PARAMS            0x01U    /*!< Byte 40 */
#define HCI_SUP_LE_SET_CONN_CTE_TX_PARAMS            0x02U    /*!< Byte 40 */
#define HCI_SUP_LE_CONN_CTE_REQ_ENABLE               0x04U    /*!< Byte 40 */
#define HCI_SUP_LE_CONN_CTE_RSP_ENABLE               0x08U    /*!< Byte 40 */
#define HCI_SUP_LE_READ_ANTENNA_INFO                 0x10U    /*!< Byte 40 */
#define HCI_SUP_LE_SET_PER_ADV_RCV_ENABLE            0x20U    /*!< Byte 40 */
#define HCI_SUP_LE_PER_ADV_SYNC_TRANSFER             0x40U    /*!< Byte 40 */
#define HCI_SUP_LE_PER_ADV_SET_INFO_TRANSFER         0x80U    /*!< Byte 40 */
#define HCI_SUP_LE_SET_PAST_PARAM                    0x01U    /*!< Byte 41 */
#define HCI_SUP_LE_SET_DEFAULT_PAST_PARAM            0x02U    /*!< Byte 41 */
#define HCI_SUP_LE_GENERATE_DHKEY_V2                 0x04U    /*!< Byte 41 */
#define HCI_SUP_LE_MODIFY_SLEEP_CLK_ACCURACY         0x10U    /*!< Byte 41 */
/* Version 5.2 */
#define HCI_SUP_LE_READ_BUF_SIZE_V2                  0x20U    /*!< Byte 41 */
#define HCI_SUP_LE_READ_ISO_TX_SYNC                  0x40U    /*!< Byte 41 */
#define HCI_SUP_LE_SET_CIG_PARAM                     0x80U    /*!< Byte 41 */
#define HCI_SUP_LE_SET_CIG_PARAM_TEST                0x01U    /*!< Byte 42 */
#define HCI_SUP_LE_CREATE_CIS                        0x02U    /*!< Byte 42 */
#define HCI_SUP_LE_REMOVE_CIG                        0x04U    /*!< Byte 42 */
#define HCI_SUP_LE_ACCEPT_CIS_REQ                    0x08U    /*!< Byte 42 */
#define HCI_SUP_LE_REJECT_CIS_REQ                    0x10U    /*!< Byte 42 */
#define HCI_SUP_LE_CREATE_BIG                        0x20U    /*!< Byte 42 */
#define HCI_SUP_LE_CREATE_BIG_TEST                   0x40U    /*!< Byte 42 */
#define HCI_SUP_LE_TERMINATE_BIG                     0x80U    /*!< Byte 42 */
#define HCI_SUP_LE_BIG_CREATE_SYNC                   0x01U    /*!< Byte 43 */
#define HCI_SUP_LE_BIG_TERMINATE_SYNC                0x02U    /*!< Byte 43 */
#define HCI_SUP_LE_REQ_PEER_SCA                      0x04U    /*!< Byte 43 */
#define HCI_SUP_LE_SETUP_ISO_DATA_PATH               0x08U    /*!< Byte 43 */
#define HCI_SUP_LE_REMOVE_ISO_DATA_PATH              0x10U    /*!< Byte 43 */
#define HCI_SUP_LE_ISO_TRANSMIT_TEST                 0x20U    /*!< Byte 43 */
#define HCI_SUP_LE_ISO_RECEIVE_TEST                  0x40U    /*!< Byte 43 */
#define HCI_SUP_LE_ISO_READ_TEST_COUNTERS            0x80U    /*!< Byte 43 */
#define HCI_SUP_LE_ISO_TEST_END                      0x01U    /*!< Byte 44 */
#define HCI_SUP_LE_SET_HOST_FEATURE                  0x02U    /*!< Byte 44 */
#define HCI_SUP_LE_READ_ISO_LINK_QUALITY             0x04U    /*!< Byte 44 */
#define HCI_SUP_LE_ENH_READ_TX_POWER_LEVEL           0x08U    /*!< Byte 44 */
#define HCI_SUP_LE_READ_REMOTE_TX_POWER_LEVEL        0x10U    /*!< Byte 44 */
#define HCI_SUP_LE_SET_PATH_LOSS_REPORT_PARAM        0x20U    /*!< Byte 44 */
#define HCI_SUP_LE_SET_PATH_LOSS_REPORT_ENABLE       0x40U    /*!< Byte 44 */
#define HCI_SUP_LE_SET_TX_POWER_REPORT_ENABLE        0x80U    /*!< Byte 44 */
#define HCI_SUP_LE_TRANSMITTER_TEST_V4               0x01U    /*!< Byte 45 */
#define HCI_SUP_SET_ECOSYSTEM_BASE_INTERVAL          0x02U    /*!< Byte 45 */
#define HCI_SUP_READ_LOCAL_SUP_CODECS_V2             0x04U    /*!< Byte 45 */
#define HCI_SUP_READ_LOCAL_SUP_CODEC_CAP             0x08U    /*!< Byte 45 */
#define HCI_SUP_READ_LOCAL_SUP_CTR_DLY               0x10U    /*!< Byte 45 */
#define HCI_SUP_CONFIG_DATA_PATH                     0x20U    /*!< Byte 45 */
#define HCI_SUP_LE_SET_DATA_REL_ADDR_CHANGES         0x40U    /*!< Byte 45 */
#define HCI_SUP_SET_MIN_ENCRYPTION_KEY_SIZE          0x80U    /*!< Byte 45 */
/* Version 5.3 */
#define HCI_SUP_LE_SET_DEF_SUBRATE                   0x01U    /*!< Byte 46 */
#define HCI_SUP_LE_SET_SUBRATE_REQ                   0x02U    /*!< Byte 46 */
/* Version 5.4 */
#define HCI_SUP_LE_SET_EXT_ADV_PARAM_V2              0x04U    /*!< Byte 46 */
#define HCI_SUP_LE_PER_ADV_SUB_DATA                  0x20U    /*!< Byte 46 */
#define HCI_SUP_LE_PER_ADV_RESP_DATA                 0x40U    /*!< Byte 46 */
#define HCI_SUP_LE_SET_PER_SYNC_SUB                  0x80U    /*!< Byte 46 */
#define HCI_SUP_LE_EXT_CREATE_CONN_V2                0x01U    /*!< Byte 47 */
#define HCI_SUP_LE_SET_PER_ADV_PARAM_V2              0x02U    /*!< Byte 47 */
/* Version Atlanta | ATLANTA TODO: Replace with actual bit values */
#define HCI_SUP_LE_CS_READ_LOCAL_SUP_CAP             0x20U    /*!< Byte 20 */
#define HCI_SUP_LE_CS_READ_REMOTE_SUP_CAP            0x40U    /*!< Byte 20 */
#define HCI_SUP_LE_CS_WRITE_CACH_REMOTE_SUP_CAP      0x80U    /*!< Byte 20 */
#define HCI_SUP_LE_CS_SECURITY_ENABLE                0x02U    /*!< Byte 24 */
#define HCI_SUP_LE_CS_SET_DEFAULT_SETTINGS           0x80U    /*!< Byte 24 */
#define HCI_SUP_LE_CS_READ_REMOTE_FAE_TABLE          0x04U    /*!< Byte 12 */
#define HCI_SUP_LE_CS_WRITE_CACH_REMOTE_FAE_TABLE    0x08U    /*!< Byte 12 */
#define HCI_SUP_LE_CS_CREATE_CONFIG                  0x40U    /*!< Byte 16 */
#define HCI_SUP_LE_CS_REMOVE_CONFIG                  0x80U    /*!< Byte 16 */
#define HCI_SUP_LE_CS_SET_CHAN_CLASSIFICATION        0x01U    /*!< Byte 29 */
#define HCI_SUP_LE_CS_SET_PROC_PARAMS                0x02U    /*!< Byte 29 */
#define HCI_SUP_LE_CS_PROCEDURE_ENABLE               0x04U    /*!< Byte 29 */
#define HCI_SUP_LE_CS_TEST                           0x08U    /*!< Byte 23 */
#define HCI_SUP_LE_CS_TEST_END                       0x10U    /*!< Byte 23 */
#define HCI_SUP_LE_SET_DECISION_DATA                 0x08U    /*!< Byte 46 */
#define HCI_SUP_LE_SET_DECISION_INSTRUCTIONS         0x10U    /*!< Byte 46 */
 ...
 */
/**@{*/
#define HCI_EVT_MASK_DISCONNECT_CMPL                 0x10U    /*!< Byte 0 */
#define HCI_EVT_MASK_ENC_CHANGE                      0x80U    /*!< Byte 0 */
#define HCI_EVT_MASK_READ_REMOTE_VER_INFO_CMPL       0x08U    /*!< Byte 1 */
#define HCI_EVT_MASK_HW_ERROR                        0x80U    /*!< Byte 1 */
#define HCI_EVT_MASK_DATA_BUF_OVERFLOW               0x02U    /*!< Byte 3 */
#define HCI_EVT_MASK_ENC_KEY_REFRESH_CMPL            0x80U    /*!< Byte 5 */
#define HCI_EVT_MASK_LE_META                         0x20U    /*!< Byte 7 */
/**@}*/
 ...
 */
/**@{*/
#define HCI_EVT_MASK_AUTH_PAYLOAD_TIMEOUT            0x80U    /*!< Byte 2 */
#define HCI_EVT_MASK_ENC_CHANGE_V2                   0x02U    /*!< Byte 3 */
/**@}*/
 ...
 */
/**@{*/
#define HCI_EVT_MASK_LE_CONN_CMPL_EVT                0x01U    /*!< Byte 0 */
#define HCI_EVT_MASK_LE_ADV_REPORT_EVT               0x02U    /*!< Byte 0 */
#define HCI_EVT_MASK_LE_CONN_UPDATE_CMPL_EVT         0x04U    /*!< Byte 0 */
#define HCI_EVT_MASK_LE_READ_REMOTE_FEAT_CMPL_EVT    0x08U    /*!< Byte 0 */
#define HCI_EVT_MASK_LE_LTK_REQ_EVT                  0x10U    /*!< Byte 0 */
/* Version 4.1 */
#define HCI_EVT_MASK_LE_REMOTE_CONN_PARAM_REQ_EVT    0x20U    /*!< Byte 0 */
/* Version 4.2 */
#define HCI_EVT_MASK_LE_DATA_LEN_CHANGE_EVT          0x40U    /*!< Byte 0 */
#define HCI_EVT_MASK_LE_READ_LOCAL_P256_PUB_KEY_CMPL 0x80U    /*!< Byte 0 */
#define HCI_EVT_MASK_LE_GENERATE_DHKEY_CMPL          0x01U    /*!< Byte 1 */
#define HCI_EVT_MASK_LE_ENHANCED_CONN_CMPL_EVT       0x02U    /*!< Byte 1 */
#define HCI_EVT_MASK_LE_DIRECT_ADV_REPORT_EVT        0x04U    /*!< Byte 1 */
/* Version 5.0 */
#define HCI_EVT_MASK_LE_PHY_UPDATE_CMPL_EVT          0x08U    /*!< Byte 1 */
#define HCI_EVT_MASK_LE_EXT_ADV_REPORT_EVT           0x10U    /*!< Byte 1 */
#define HCI_EVT_MASK_LE_PER_ADV_SYNC_EST_EVT         0x20U    /*!< Byte 1 */
#define HCI_EVT_MASK_LE_PER_ADV_REPORT_EVT           0x40U    /*!< Byte 1 */
#define HCI_EVT_MASK_LE_PER_ADV_SYNC_LOST_EVT        0x80U    /*!< Byte 1 */
#define HCI_EVT_MASK_LE_SCAN_TIMEOUT_EVT             0x01U    /*!< Byte 2 */
#define HCI_EVT_MASK_LE_ADV_SET_TERM_EVT             0x02U    /*!< Byte 2 */
#define HCI_EVT_MASK_LE_SCAN_REQ_RCVD_EVT            0x04U    /*!< Byte 2 */
#define HCI_EVT_MASK_LE_CH_SEL_ALGO_EVT              0x08U    /*!< Byte 2 (Bit 19) */
/* Version 5.1 */
#define HCI_EVT_MASK_LE_CONNLESS_IQ_REPORT_EVT       0x10U    /*!< Byte 2 */
#define HCI_EVT_MASK_LE_CONN_IQ_REPORT_EVT           0x20U    /*!< Byte 2 */
#define HCI_EVT_MASK_LE_CTE_REQ_FAILED_EVT           0x40U    /*!< Byte 2 */
#define HCI_EVT_MASK_LE_PER_SYNC_TRSF_RCVT_EVT       0x80U    /*!< Byte 2 (Bit 23) */
/* Version 5.2 */
#define HCI_EVT_MASK_LE_CIS_EST_EVT                  0x01U    /*!< Byte 3 (Bit 24) */
#define HCI_EVT_MASK_LE_CIS_REQ_EVT                  0x02U    /*!< Byte 3 */
#define HCI_EVT_MASK_LE_CREATE_BIG_CMPL_EVT          0x04U    /*!< Byte 3 */
#define HCI_EVT_MASK_LE_TERMINATE_BIG_CMPL_EVT       0x08U    /*!< Byte 3 */
#define HCI_EVT_MASK_LE_BIG_SYNC_EST_EVT             0x10U    /*!< Byte 3 */
#define HCI_EVT_MASK_LE_BIG_SYNC_LOST_EVT            0x20U    /*!< Byte 3 */
#define HCI_EVT_MASK_LE_PEER_SCA_CMPL_EVT            0x40U    /*!< Byte 3 */
#define HCI_EVT_MASK_LE_PATH_LOSS_REPORT_EVT         0x80U    /*!< Byte 3 */
#define HCI_EVT_MASK_LE_TX_POWER_REPORT_EVT          0x01U    /*!< Byte 4 (Bit 32)*/
#define HCI_EVT_MASK_LE_BIG_INFO_ADV_RPT_EVT         0x02U    /*!< Byte 4 */
/* Version 5.3 */
#define HCI_EVT_MASK_LE_SUBRATE_CHANGE_EVT           0x04U    /*!< Byte 4 */
/* Version 5.4 */
#define HCI_EVT_MASK_LE_PER_ADV_SYNC_EST_V2_EVT      0x08U    /*!< Byte 4 */
#define HCI_EVT_MASK_LE_PER_ADV_REPORT_V2_EVT        0x10U    /*!< Byte 4 */
#define HCI_EVT_MASK_LE_PER_SYNC_TRSF_RCVD_V2_EVT    0x20U    /*!< Byte 4 */
#define HCI_EVT_MASK_LE_PER_ADV_SUBEVT_DATA_REQ_EVT  0x40U    /*!< Byte 4 */
#define HCI_EVT_MASK_LE_PER_ADV_RSP_REPORT_EVT       0x80U    /*!< Byte 4 */
#define HCI_EVT_MASK_LE_ENHANCED_CONN_CMPL_V2_EVT    0x01U    /*!< Byte 5 (Bit 40) */
/* Version Atlanta | ATLANTA TODO: Replace with actual bit and byte */
#define HCI_EVT_MASK_LE_CS_READ_REMOTE_SUP_CAP_CMPL_EVT     0x08U    /*!< Byte 5 */
#define HCI_EVT_MASK_LE_CS_READ_REMOTE_FAE_TBL_CMPL_EVT     0x10U    /*!< Byte 5 */
#define HCI_EVT_MASK_LE_CS_SECURITY_ENABLE_CMPL_EVT         0x20U    /*!< Byte 5 */
#define HCI_EVT_MASK_LE_CS_CONFIG_CMPL_EVT                  0x40U    /*!< Byte 5 */
#define HCI_EVT_MASK_LE_CS_PROCEDURE_ENABLE_CMPL_EVT        0x80U    /*!< Byte 5 */
#define HCI_EVT_MASK_LE_CS_SUBEVENT_RESULT_EVT              0x01U    /*!< Byte 6 (Bit 48)*/
#define HCI_EVT_MASK_LE_CS_SUBEVENT_RESULT_CON_EVT          0x02U    /*!< Byte 6 */
...
/**@{*/
/* Version 4.0 */
#define HCI_LE_SUP_FEAT_ENCRYPTION                   0x0000000000000001U  /*!< Encryption supported */
/* Version 4.1 */
#define HCI_LE_SUP_FEAT_CONN_PARAM_REQ_PROC          0x0000000000000002U  /*!< Connection Parameters Request Procedure supported */
#define HCI_LE_SUP_FEAT_EXT_REJECT_IND               0x0000000000000004U  /*!< Extended Reject Indication supported */
#define HCI_LE_SUP_FEAT_SLV_INIT_FEAT_EXCH           0x0000000000000008U  /*!< Slave-Initiated Features Exchange supported */
#define HCI_LE_SUP_FEAT_LE_PING                      0x0000000000000010U  /*!< LE Ping supported */
/* Version 4.2 */
#define HCI_LE_SUP_FEAT_DATA_LEN_EXT                 0x0000000000000020U  /*!< Data Length Extension supported */
#define HCI_LE_SUP_FEAT_PRIVACY                      0x0000000000000040U  /*!< LL Privacy supported */
#define HCI_LE_SUP_FEAT_EXT_SCAN_FILT_POLICY         0x0000000000000080U  /*!< Extended Scan Filter Policy supported */
/* Version 5.0 */
#define HCI_LE_SUP_FEAT_LE_2M_PHY                    0x0000000000000100U  /*!< LE 2M PHY supported */
#define HCI_LE_SUP_FEAT_STABLE_MOD_IDX_TRANSMITTER   0x0000000000000200U  /*!< Stable Modulation Index - Transmitter supported */
#define HCI_LE_SUP_FEAT_STABLE_MOD_IDX_RECEIVER      0x0000000000000400U  /*!< Stable Modulation Index - Receiver supported */
#define HCI_LE_SUP_FEAT_LE_CODED_PHY                 0x0000000000000800U  /*!< LE Coded PHY supported */
#define HCI_LE_SUP_FEAT_LE_EXT_ADV                   0x0000000000001000U  /*!< LE Extended Advertising supported */
#define HCI_LE_SUP_FEAT_LE_PER_ADV                   0x0000000000002000U  /*!< LE Periodic Advertising supported */
#define HCI_LE_SUP_FEAT_CH_SEL_2                     0x0000000000004000U  /*!< Channel Selection Algorithm #2 supported */
#define HCI_LE_SUP_FEAT_LE_POWER_CLASS_1             0x0000000000008000U  /*!< LE Power Class 1 supported */
#define HCI_LE_SUP_FEAT_MIN_NUN_USED_CHAN            0x0000000000010000U  /*!< Minimum Number of Used Channels Procedure supported */
/* Version 5.1 */
#define HCI_LE_SUP_FEAT_CONN_CTE_REQ                 0x0000000000020000U  /*!< Connection CTE Request supported */
#define HCI_LE_SUP_FEAT_CONN_CTE_RSP                 0x0000000000040000U  /*!< Connection CTE Response supported */
#define HCI_LE_SUP_FEAT_CONNLESS_CTE_TRANS           0x0000000000080000U  /*!< Connectionless CTE Transmitter supported */
#define HCI_LE_SUP_FEAT_CONNLESS_CTE_RECV            0x0000000000100000U  /*!< Connectionless CTE Receiver supported */
#define HCI_LE_SUP_FEAT_ANTENNA_SWITCH_AOD           0x0000000000200000U  /*!< Antenna Switching during CTE Transmission (AoD) supported */
#define HCI_LE_SUP_FEAT_ANTENNA_SWITCH_AOA           0x0000000000400000U  /*!< Antenna Switching during CTE Reception (AoA) supported */
#define HCI_LE_SUP_FEAT_RECV_CTE                     0x0000000000800000U  /*!< Receive Constant Tone Extension supported */
#define HCI_LE_SUP_FEAT_PAST_SENDER                  0x0000000001000000U  /*!< Periodic Advertising Sync Transfer Sender supported */
#define HCI_LE_SUP_FEAT_PAST_RECIPIENT               0x0000000002000000U  /*!< Periodic Advertising Sync Transfer Recipient supported */
#define HCI_LE_SUP_FEAT_SCA_UPDATE                   0x0000000004000000U  /*!< Sleep Clock Accuracy Update supported */
#define HCI_LE_SUP_FEAT_REMOTE_PUB_KEY_VALIDATION    0x0000000008000000U  /*!< Remote Public Key Validation supported */
/* Version 5.2 */
#define HCI_LE_SUP_FEAT_CIS_MASTER                   0x0000000010000000U  /*!< Connected Isochronous Master Role supported */
#define HCI_LE_SUP_FEAT_CIS_SLAVE                    0x0000000020000000U  /*!< Connected Isochronous Slave Role supported */
#define HCI_LE_SUP_FEAT_ISO_BROADCASTER              0x0000000040000000U  /*!< Isochronous Broadcaster Role supported */
#define HCI_LE_SUP_FEAT_ISO_SYNC_RECEIVER            0x0000000080000000U  /*!< Isochronous Synchronized Receiver Role supported */
#define HCI_LE_SUP_FEAT_ISO_HOST_SUPPORT             0x0000000100000000U  /*!< Host support for ISO Channels */
#define HCI_LE_SUP_FEAT_POWER_CONTROL_REQUEST        0x0000000200000000U  /*!< Power control requests supported */
#define HCI_LE_SUP_FEAT_POWER_CHANGE_IND             0x0000000400000000U  /*!< Power control power change indication supported */
#define HCI_LE_SUP_FEAT_PATH_LOSS_MONITOR            0x0000000800000000U  /*!< Path loss monitoring supported */
/* --- Core Spec 5.3 --- */
#define HCI_LE_SUP_FEAT_PER_ADV_ADI                  0x0000001000000000U  /*!< Periodic advertising ADI field supported */
#define HCI_LE_SUP_FEAT_CONN_SUBRATE                 0x0000002000000000U  /*!< Connection subrating supported */
#define HCI_LE_SUP_FEAT_CONN_SUBRATE_HOST_SUPPORT    0x0000004000000000U  /*!< Host support for connection subrating */
#define HCI_LE_SUP_FEAT_CHANNEL_CLASSIFICATION       0x0000008000000000U  /*!< Channel classification supported */
/* --- Core Spec 5.4 --- */
#define HCI_LE_SUP_FEAT_ADV_CODING_SEL               0x0000010000000000U  /*!< Advertising coding selection supported */
#define HCI_LE_SUP_FEAT_ADV_CODING_SEL_HOST_SUPPORT  0x0000020000000000U  /*!< Host support for advertising coding selection */
#define HCI_LE_SUP_FEAT_PAWR_ADVERTISER              0x0000080000000000U  /*!< Periodic Advertising With Response  Advertiser supported. */
#define HCI_LE_SUP_FEAT_PAWR_SCANNER                 0x0000100000000000U  /*!< Periodic Advertising With Response  Scanner supported. */
/**@}*/
...
#define HCI_LE_FEAT_BIT_PAWR_ADVERTISER              40  /*!< Host support for PAWR advertising */
#define HCI_LE_FEAT_BIT_PAWR_SCANNER                 41  /*!< Host support for PAWR scanning */
/**@}*/
...
#define HCI_EXT_ADV_MAX_INTERVAL                     0xFFFFFF
                                                             /*!< Extended advertising max interval */
 ...
 */
/**@{*/
#define HCI_SCAN_PHY_LE_1M_BIT                       (1U<<0)  /*!< LE 1M PHY */
#define HCI_SCAN_PHY_LE_2M_BIT                       (1U<<1)  /*!< LE 2M PHY */
#define HCI_SCAN_PHY_LE_CODED_BIT                    (1U<<2)  /*!< LE Coded PHY  */
/**@}*/
 ...
 */
/**@{*/
#define HCI_INIT_PHY_LE_1M_BIT                       (1U<<0)  /*!< LE 1M PHY */
#define HCI_INIT_PHY_LE_2M_BIT                       (1U<<1)  /*!< LE 2M PHY */
#define HCI_INIT_PHY_LE_CODED_BIT                    (1U<<2)  /*!< LE Coded PHY  */
/**@}*/
...
*/
/**@{*/
#define HCI_TRANS_PHY_LE_1M_BIT                      (1U<<0)  /*!< LE 1M PHY */
#define HCI_TRANS_PHY_LE_2M_BIT                      (1U<<1)  /*!< LE 2M PHY */
#define HCI_TRABS_PHY_LE_CODED_BIT                   (1U<<2)  /*!< LE Coded PHY  */
/**@}*/
 ...
 */
/**@{*/
#define HCI_ADV_PROP_CONN_ADV_BIT                    (1U<<0)  /*!< Connectable advertising bit */
#define HCI_ADV_PROP_SCAN_ADV_BIT                    (1U<<1)  /*!< Scannable advertising bit */
#define HCI_ADV_PROP_DIRECT_ADV_BIT                  (1U<<2)  /*!< Directed advertising bit */
#define HCI_ADV_PROP_CONN_DIRECT_ADV_BIT             (1U<<3)  /*!< High duty cycle connectable directed advertising bit */
#define HCI_ADV_PROP_USE_LEG_PDU_BIT                 (1U<<4)  /*!< Use legacy advertising PDUs bit */
#define HCI_ADV_PROP_OMIT_ADV_ADDR_BIT               (1U<<5)  /*!< Omit advertiser's address from all PDUs (anonymous advertising) bit */
#define HCI_ADV_PROP_INC_TX_PWR_BIT                  (1U<<6)  /*!< Include TxPower in extended header of advertising PDU bit */
/**@}*/
 ...
 */
/**@{*/
#define HCI_ADV_RPT_CONN_ADV_BIT                     (1U<<0)  /*!< Connectable advertising event bit */
#define HCI_ADV_RPT_SCAN_ADV_BIT                     (1U<<1)  /*!< Scannable advertising event bit */
#define HCI_ADV_RPT_DIRECT_ADV_BIT                   (1U<<2)  /*!< Directed advertising event bit */
#define HCI_ADV_RPT_SCAN_RSP_BIT                     (1U<<3)  /*!< Scan response event bit */
#define HCI_ADV_RPT_LEG_ADV_BIT                      (1U<<4)  /*!< Legacy advertising PDU event bit */
#define HCI_ADV_RPT_DATA_STATUS_BITS                 (3U<<5)  /*!< Data status bits */
/**@}*/
...
*/
/**@{*/
#define HCI_OPTIONS_FILT_POLICY_BIT                  (1U<<0)  /*!< Filter policy bit */
#define HCI_OPTIONS_INIT_RPT_ENABLE_BIT              (1U<<1)  /*!< Initial periodic advertisement reporting bit */
#define HCI_OPTIONS_INIT_DUP_FILT_ENABLE_BIT         (1U<<2)  /*!< Initial periodic advertisement duplicate filtering bit */
...
/** \name Periodic advertising receive enable bits
*
*/
/**@{*/
#define HCI_RCV_RPT_ENABLE_BIT                       (1U<<0)  /*!< Periodic advertisement receive reporting bit */
#define HCI_RCV_DUP_FILT_ENABLE_BIT                  (1U<<1)  /*!< Periodic advertisement receive duplicate filtering bit */

#define HCI_RCV_ALL_BITS                             (HCI_RCV_RPT_ENABLE_BIT | \
                                                     HCI_RCV_DUP_FILT_ENABLE_BIT)
                                                     /*!< All receive bits. */
/**@}*/
 ...
 */
/**@{*/
#define HCI_PHY_NONE                                 0x00U    /*!< No selected PHY */
#define HCI_PHY_LE_1M_BIT                            (1U<<0)  /*!< LE 1M PHY */
#define HCI_PHY_LE_2M_BIT                            (1U<<1)  /*!< LE 2M PHY */
#define HCI_PHY_LE_CODED_BIT                         (1U<<2)  /*!< LE Coded PHY */
/**@}*/
 ...
 */
/**@{*/
#define HCI_ALL_PHY_ALL_PREFERENCES                  0x00U    /*!< All PHY preferences */
#define HCI_ALL_PHY_TX_PREFERENCE_BIT                (1U<<0)  /*!< Tx PHY preference */
#define HCI_ALL_PHY_RX_PREFERENCE_BIT                (1U<<1)  /*!< Rx PHY preference */
/**@}*/
...
*/
/**@{*/
#define HCI_CTE_TYPE_PERMIT_AOA_RSP_BIT              (1U<<0)  /*!< Allow AoA Constant Tone Extension Response */
#define HCI_CTE_TYPE_PERMIT_AOD_RSP_1_US_BIT         (1U<<1)  /*!< Allow AoD Constant Tone Extension Response with 1 us slots */
#define HCI_CTE_TYPE_PERMIT_AOD_RSP_2_US_BIT         (1U<<2)  /*!< Allow AoD Constant Tone Extension Response with 2 us slots */
/**@}*/

/** \name CTE maximum length pattern length
*
*/
/**@{*/
#define HCI_CTE_LEN_MIN_LEN_8US                      0x02    /*!< CTE length minimum length in 8 microsecond units. */
#define HCI_CTE_LEN_MAX_LEN_8US                      0x14    /*!< CTE length minimum length in 8 microsecond units. */
/**@}*/
...
*/
/**@{*/
#define HCI_SYNC_CTE_TYPE_DONT_SYNC_AOA_BIT          (1U<<0)  /*!< Do not sync to packets with an AoA Constant Tone Extension */
#define HCI_SYNC_CTE_TYPE_DONT_SYNC_AOD_1_US_BIT     (1U<<1)  /*!< Do not sync to packets with an AoD Constant Tone Extension with 1 us slots */
#define HCI_SYNC_CTE_TYPE_DONT_SYNC_AOD_2_US_BIT     (1U<<2)  /*!< Do not sync to packets with an AoD Constant Tone Extension with 2 us slots */
#define HCI_SYNC_CTE_TYPE_DONT_SYNC_TYPE_3_BIT       (1U<<3)  /*!< Do not sync to packets with a type 3 Constant Tone Extension */
/**@}*/
...
#define HCI_PER_ADV_RSP_RPT_NUM_RESPONSES_OFFSET     3       /*!< Number of responses in a periodic advertising response report data */
#define HCI_PER_ADV_RSP_RPT_FIRST_LEN_OFFSET         9       /*!< Offset to first data length in PA response report */
#define HCI_PER_ADV_RSP_RPT_NEXT_LEN_OFFSET          6       /*!< Offset to the next data length in PA response report */
#define HCI_VENDOR_DATA_OFFSET                       3       /*!< Offset to align the data from vendor events with regular event data */
#define HCI_VENDOR_SUBEVENT_OFFSET                   2       /*!< Offset to subevent field in vendor events */
/**@}*/
...
*/
/**@{*/
#define HCI_PER_ADV_ENABLE_ADV_ENABLE_BIT            (1U<<0) /*!< Enable bit for periodic advertising enable command */
#define HCI_PER_ADV_ENABLE_ADI_ENABLE_BIT            (1U<<1) /*!< Enable bit for periodic advertising ADI inclusion */
/**@}*/
...
*/
/**@{*/
#define HCI_ISO_DATA_PATH_INPUT_BIT                  (1U<<HCI_ISO_DATA_DIR_INPUT)  /*!< Data path input bit. */
#define HCI_ISO_DATA_PATH_OUTPUT_BIT                 (1U<<HCI_ISO_DATA_DIR_OUTPUT) /*!< Data path output bit. */
/**@}*/
...
*/
/**@{*/
#define HCI_CODEC_TRANS_CIS_BIT                      (1U<<2) /*!< Codec supported over LE CIS. */
#define HCI_CODEC_TRANS_BIS_BIT                      (1U<<3) /*!< Codec supported over LE BIS. */
/**@}*/
...
#define HCI_ID_EMMICROELECTRONIC                     0x005A  /*!< EM Microelectronic company ID */
/**@}*/
 ...
 */
/**@{*/
#define HCI_ID_TRANSPARENT                           0x03    /*!< Transparent air mode */
 ...
 */
/**@{*/
#define HCI_CHANGE_REASON_ADV_DATA_TRIG_BIT  (1U << 0) /*!< Change address when advertising data changes */
#define HCI_CHANGE_REASON_SCN_DATA_TRIG_BIT  (1U << 1) /*!< Change address when scan response data changes */
