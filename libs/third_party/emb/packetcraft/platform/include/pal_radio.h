...
/*************************************************************************************************/
/*!
 *  \brief      Initialize RF transmit output min and max power.
 *
 *  This function initializes internal min and max values for the transmit output power. By
 *  default, the min power is set to -57dBm while the max power depend on both the available
 *  power supply and the value written into the locked power register.
 */
/*************************************************************************************************/
void PalRadioInitTxPower(void);
 ...
 */
/*************************************************************************************************/
int8_t PalRadioGetActualTxPower(int8_t txPwr, bool compFlag);
