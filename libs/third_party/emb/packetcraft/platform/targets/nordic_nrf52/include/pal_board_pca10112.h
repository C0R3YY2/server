 ...
 *  \file
 *
 *  \brief      PAL internal definitions for PCA10112 (nRF21540-DK) board support.
 *
...
#ifndef PAL_BOARD_PCA10112_H
#define PAL_BOARD_PCA10112_H
...
#define NRF_PIN_FEM_MODE      NRF_GPIO_PIN_MAP(0, 17)
#define NRF_PIN_FEM_RXEN      NRF_GPIO_PIN_MAP(0, 19)
#define NRF_PIN_FEM_ANTSEL    NRF_GPIO_PIN_MAP(0, 20)
#define NRF_PIN_FEM_TXEN      NRF_GPIO_PIN_MAP(0, 22)
#define NRF_PIN_FEM_PDN       NRF_GPIO_PIN_MAP(0, 23)
#define NRF_PIN_FEM_CSN       NRF_GPIO_PIN_MAP(0, 21)
...
#define NRF_PIN_SPI_SCK       NRF_GPIO_PIN_MAP(0, 27)
#define NRF_PIN_SPI_MOSI      NRF_GPIO_PIN_MAP(0,  2)
#define NRF_PIN_SPI_MISO      NRF_GPIO_PIN_MAP(0, 26)
#define NRF_PIN_SPI_SS        NRF_GPIO_PIN_MAP(1, 13)
