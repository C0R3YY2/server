...
#define NRFX_I2S_CONFIG_SCK_PIN NRF_GPIO_PIN_MAP(0,20)
#define NRFX_I2S_CONFIG_LRCK_PIN NRF_GPIO_PIN_MAP(0,22)
#define NRFX_I2S_CONFIG_MCK_PIN NRF_GPIO_PIN_MAP(0,19)
#define NRFX_I2S_CONFIG_SDOUT_PIN NRF_GPIO_PIN_MAP(0,24)
#define NRFX_I2S_CONFIG_SDIN_PIN NRF_GPIO_PIN_MAP(0,23)
#endif
...
#define NRFX_TIMER3_ENABLED 0   /* TIMER3 is used with direct register access. */
