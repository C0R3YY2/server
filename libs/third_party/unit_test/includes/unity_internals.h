 ...
 *-------------------------------------------------------*/
extern void UNITTEST_addChar(char a);
#define UNITY_OUTPUT_CHAR(a) UNITTEST_addChar(a)
...
/* 2 Lines below added by Guillaume S. */
...
struct _Unity
{
    ...
    UNITY_COUNTER_TYPE TestWarnings;
    UNITY_COUNTER_TYPE CurrentTestFailed;
    UNITY_COUNTER_TYPE CurrentTestIgnored;
    UNITY_COUNTER_TYPE CurrentTestWarned;
    jmp_buf AbortFrame;
};
...
void UnityWarn(const char* message, const UNITY_LINE_TYPE line);
...
#define UNITY_TEST_WARN(line, message)   UnityWarn( (message), (UNITY_LINE_TYPE)(line))

/*-------------------------------------------------------
 * Test Asserts
 *-------------------------------------------------------*/

#define UNITY_TEST_STEP(step, line, message)                                                     UnityMessageEvent((step), (line), (0), (message));
#define UNITY_TEST_ASSERT(condition, line, message)                                              if (condition) {} else {UnityMessageEvent((0), (line), (1), (message));UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), (message));}
...
#define UNITY_TEST_WARNING(condition, line, message)                                             if (condition) {} else {UnityMessageEvent((0), (line), (0), (message));UNITY_TEST_WARN((UNITY_LINE_TYPE)(line), (message));}
