...
#define TEST_WARN_MESSAGE(message)                                                                 UNITY_TEST_WARN(__LINE__, (message))
#define TEST_WARN()                                                                                UNITY_TEST_WARN(__LINE__, NULL)
#define TEST_ONLY()

/* It is not necessary for you to call PASS. A PASS condition is assumed if nothing fails.
 * This method allows you to abort a test immediately with a PASS state, ignoring the remainder of the test. */
#define UNITY_TEST_PASS()                                                                                longjmp(Unity.AbortFrame, 1)
...
#define TEST_WARNING(condition)                                                                    UNITY_TEST_WARNING(      (condition), __LINE__, " Expression Evaluated To FALSE")
...
/* Boolean */
#define TEST_STEP(step, message)                                                                   UNITY_TEST_STEP( (step), __LINE__, (message))
