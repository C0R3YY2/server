...
* __first__ member of the derived struct   .
* -see qf_qactive c
*/
typedef struct QActive {
    ...
    */
    ...
    /*! QF priority (1 .. QF MAX ACTIVE) of this active object. */
    uint8_t prio;
...
bool QActive_defer(QActive const * const me,
                   struct QEQueue * const eq, QEvt const * const e);
...
*
* @sa ::QTimeEvt for the description of the data members @n -see oop
*
* @note
