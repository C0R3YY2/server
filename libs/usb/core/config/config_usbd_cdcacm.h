/***************************************************************************
 *
 *            Copyright (c) 2006-2020 by HCC Embedded
 *
...
#if VER_USBD_CDCACM_MAJOR != 5 || VER_USBD_CDCACM_MINOR != 8
...
#define USBD_CDCACM_RX_BUFFER_SIZE  64

#define USBD_CDCACM_TASK_STACK_SIZE 1024

/* Number of Receive buffers on each CDC line */
#define USBD_CDCACM_BUF_NUM_LINE_0  2
